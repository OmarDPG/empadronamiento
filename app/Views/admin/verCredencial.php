                ...
                <div class="col mb-5">
                    <div class="card-header">
                        <p>
                            ...
                            <a href="<?php echo base_url() . "/admin/generarCredencial/" . $id_certificado ?>" download target="_blank" class="btn btn-primary verde"><i class="fa-solid fa-file-arrow-down"></i> Descargar</a>
                        </p>
                    </div>
                    <div class="card-header">
                    </div>
                    ...
                    <div class="card-body bg-light">
                        <div class="panel">
                            <div class="embed-responsive embed-responsive-4by3 ratio ratio-16x9" style="margin-top: 30px; ">
                                <iframe class="embed-responsive-item" src="<?php echo base_url() . "/admin/generarCredencial/" . $id_certificado; ?>"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
