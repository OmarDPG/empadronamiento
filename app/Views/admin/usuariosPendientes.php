    ...
    <main>
        <div class="container-fluid px-4"><br>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active"><h3>Registro de usuario pendientes por aprobacion.</h3></li><br>
            </ol>
            <!-- <div class="mb-3">
                        ...
                        <tbody>
                            ...
                            foreach ($resultados as $dato) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $dato->nombre_entidad ?></td>
                                    <td><a href="<?php echo base_url() . "admin/verDatosUsuario/" . $dato->id_usuario ?>" class="btn btn-warning"><i class="fa-solid fa-pencil"></i></a></td>
                                    <td><a href="<?php echo base_url() . "admin/aprobarUsuario/" . $dato->id_usuario ?>" class="btn btn-success"><i class="fa-solid fa-check"></i></a></td>
                                    <td><a href="#exampleModalToggle" data-href="<?php echo base_url() . "/admin/eliminarSolicitudUsuario/" . $dato->id_usuario; ?>" data-bs-toggle="modal" data-target="#exampleModalToggle" data-placement="top" title="Eliminar registro" class="btn btn-danger"><i class="fa-solid fa-xmark"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
