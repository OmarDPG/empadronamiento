...
var PptxGenJS = function() {
    ...
    y = function() {
        return (y = Object.assign || function(e) {
            for (var t, a = 1, A = arguments.length; a < A; a++) for (var o in  t = arguments[a]) Object.prototype.hasOwnProperty.call(t, o) && (e[o] = t[o]);
            return e
    ...
    function d(A, o) {
        ...
        function e(a) {
            return function(e) {
                ...
                for (; c = i && t[i = 0] ? 0 : c;) try {
                    if (n = 1, r && (l = 2 & t[0] ? r.
                    return : t[0] ? r.
                    throw || ((l = r.
                    return) && l.call(r), 0) : r.next) && !(l = l.call(r, t[1])).done) return l;
                    ...
                    case 7:
                        ...
                        continue;
                    default:
                        if (! (l = 0 < (l = c.trys).length && l[l.length - 1]) && (6 === t[0] || 2 === t[0])) {
                            c = 0;
                            continue
                        }
                        if (3 === t[0] && (!l || t[1] > l[0] && t[1] < l[3])) c.label = t[1];
                        else
                        if (6 === t[0] && c.label < l[1]) c.label = l[1],
                        l = t;
                        else {
                            if (! (l && c.label < l[2])) {
                                l[2] && c.ops.pop(),
    ...
    function Q(e, t, a) {
        if (a || 2 === arguments.length) for (var A, o = 0, n = t.length; o < n; o++) ! A && o in  t || ((A = A || Array.prototype.slice.call(t, 0, o))[o] = t[o]);
        return e.concat(A || Array.prototype.slice.call(t))
    }
    var r, l, S, E, G, A, j, Y, c, v, X, n, N, o, f, e, F = 914400,
    x = 12700,
    u = "\r\n",
    H = 2147483649,
    W = /^[0-9a-fA-F]{6}$/,
    ...
    de = ["C0504D", "4F81BD", "9BBB59", "8064A2", "4BACC6", "F79646", "628FC6", "C86360", "C0504D", "4F81BD", "9BBB59", "8064A2", "4BACC6", "F79646", "628FC6", "C86360"],
    fe = ["5DA5DA", "FAA43A", "60BD68", "F17CB0", "B2912F", "B276B2", "DECF3F", "F15854", "A7A7A7", "5DA5DA", "FAA43A", "60BD68", "F17CB0", "B2912F", "B276B2", "DECF3F", "F15854", "A7A7A7"],
    ue = ((e = r = r || {}).left = "left", e.center = "center", e.right = "right", e.justify = "justify", (e = l = l || {}).b = "b", e.ctr = "ctr", e.t = "t", "{F7021451-1387-4CA6-816F-3879F97B5CBC}"),
    ...
    function R(e, t, a) {
        return "number" == typeof(e = "string" != typeof e || isNaN(Number(e)) ? e : Number(e)) && e < 100 ? M(e) : "number" == typeof e && 100 <= e ? e : "string" == typeof e && e.includes("%") ? (!t || "X" !== t) && t && "Y" === t ? Math.round(parseFloat(e) / 100 * a.height) : Math.round(parseFloat(e) / 100 * a.width) : 0
    }
    function he(e) {
    ...
    function M(e) {
        return "number" == typeof e && 100 < e ? e : ("string" == typeof e && (e = Number(e.replace(/in*/gi, ""))), Math.round(F * e))
    }
    function O(e) {
        e = Number(e) || 0;
    ...
    function z(e, t) {
        var e = (e || "").replace("#", ""),
        a = (W.test(e) || e === A.background1 || e === A.background2 || e === A.text1 || e === A.text2 || e === A.accent1 || e === A.accent2 || e === A.accent3 || e === A.accent4 || e === A.accent5 || e === A.accent6 || (console.warn('"'.concat(e, '" is not a valid scheme color or hex RGB! "').concat(w, "\" used instead. Only provide 6-digit RGB or 'pptx.SchemeColor' values!")), e = w), W.test(e) ? "srgbClr" : "schemeClr"),
        e = 'val="' + (W.test(e) ? e.toUpperCase() : e) + '"';
        return t ? "<a:".concat(a, " ").concat(e, ">").concat(t, "</a:").concat(a, ">") : "<a:".concat(a, " ").concat(e, "/>")
    }
    function U(e) {
        var t = "solid",
        a = "",
        A = "",
        o = "";
        return e && ("string" == typeof e ? a = e : (e.type && (t = e.type), e.color && (a = e.color), e.alpha && (A += '<a:alpha val="'.concat(Math.round(1e3 * (100 - e.alpha)), '"/>')), e.transparency && (A += '<a:alpha val="'.concat(Math.round(1e3 * (100 - e.transparency)), '"/>'))), o += "solid" === t ? "<a:solidFill>".concat(z(a, A), "</a:solidFill>") : ""),
        o
    }
    function g(e) {
    ...
    function be(e) {
        if (e && "object" == typeof e) return "outer" !== e.type && "inner" !== e.type && "none" !== e.type && (console.warn("Warning: shadow.type options are `outer`, `inner` or `none`."), e.type = "outer"),
        e.angle && ((isNaN(Number(e.angle)) || e.angle < 0 || 359 < e.angle) && (console.warn("Warning: shadow.angle can only be 0-359"), e.angle = 270), e.angle = Math.round(Number(e.angle))),
        e.opacity && ((isNaN(Number(e.opacity)) || e.opacity < 0 || 1 < e.opacity) && (console.warn("Warning: shadow.opacity can only be 0-1"), e.opacity = .75), e.opacity = Number(e.opacity)),
    ...
    function ye(e, f, t, a) {
        ...
        return e.forEach(function(e, t) {
            for (var d = [], a = 0, A = 0, o = [], n = (e.forEach(function(e) {
                var t;
                o.push({
                    _type: N.tablecell,
                    text: [],
                ...
                e.options.margin && 1 <= e.options.margin[0] ? (null != (t = e.options) && t.margin && e.options.margin[0] && O(e.options.margin[0]) > a ? a = O(e.options.margin[0]) : null != f && f.margin && f.margin[0] && O(f.margin[0]) > a && (a = O(f.margin[0])), null != (t = e.options) && t.margin && e.options.margin[2] && O(e.options.margin[2]) > A ? A = O(e.options.margin[2]) : null != f && f.margin && f.margin[2] && O(f.margin[2]) > A && (A = O(f.margin[2]))) : (null != (t = e.options) && t.margin && e.options.margin[0] && M(e.options.margin[0]) > a ? a = M(e.options.margin[0]) : null != f && f.margin && f.margin[0] && M(f.margin[0]) > a && (a = M(f.margin[0])), null != (t = e.options) && t.margin && e.options.margin[2] && M(e.options.margin[2]) > A ? A = M(e.options.margin[2]) : null != f && f.margin && f.margin[2] && M(f.margin[2]) > A && (A = M(f.margin[2])))
            }), h(), p += a + A, f.verbose && 0 === t && console.log("| SLIDE [".concat(u.length, "]: emuSlideTabH ...... = ").concat((s / F).toFixed(1), " ")), e.forEach(function(a, A) {
                var e, o, t, n, r, l, c, i, s = {
                    _type: N.tablecell,
                    _lines: null,
                    _lineHeight: M((null != (s = a.options) && s.fontSize ? a.options.fontSize : f.fontSize || P) * (V + (f.autoPageLineWeight || 0)) / 100),
                    text: [],
                    options: a.options
                },
                p = (s.options.rowspan && (s._lineHeight = 0), s.options.autoPageCharWeight = f.autoPageCharWeight || null, f.colW[A]);
                a.options.colspan && Array.isArray(f.colW) && (p = f.colW.filter(function(e, t) {
                    return A <= t && t < t + a.options.colspan
                }).reduce(function(e, t) {
                    return e + t
                })),
                s._lines = (p = p, o = !1, t = 2.3 + (null != (t = (e = a).options) && t.autoPageCharWeight ? e.options.autoPageCharWeight : 0), n = Math.floor(p / x * F) / ((null != (p = e.options) && p.fontSize ? e.options.fontSize : P) / t), r = [], p = [], l = [], c = [], e.text && 0 === e.text.toString().trim().length ? p.push({
                    _type: N.tablecell,
                    text: " "
                }) : "number" == typeof e.text || "string" == typeof e.text ? p.push({
                    _type: N.tablecell,
                    text: (e.text || "").toString().trim()
                }) : Array.isArray(e.text) && (p = e.text), o && (console.log("[1/4] inputCells"), p.forEach(function(e, t) {
                    return console.log("[1/4] [".concat(t + 1, "] cell: ").concat(JSON.stringify(e)))
                })), i = [], p.forEach(function(t) {
                    var e;
                    "string" == typeof t.text && (1 < t.text.split("\n").length ? t.text.split("\n").forEach(function(e) {
                        i.push({
                            _type: N.tablecell,
                            text: e,
                            options: y(y({},
                        ...
                        text: t.text.trim(),
                        options: t.options
                    }), null != (e = t.options)) && e.breakLine && (o && console.log("inputCells: new line > ".concat(JSON.stringify(i))), l.push(i), i = []),
                    0 < i.length && (l.push(i), i = [])
                }), o && (console.log("[2/4] inputLines1 (".concat(l.length, ")")), l.forEach(function(e, t) {
                    return console.log("[2/4] [".concat(t + 1, "] line: ").concat(JSON.stringify(e)))
                    ...
                    e.forEach(function(A) {
                        ...
                        n.forEach(function(e, t) {
                            var a = y({},
                            A.options);
                            null != a && a.breakLine && (a.breakLine = t + 1 === n.length),
                            o.push({
                                _type: N.tablecell,
                                text: e + (t + 1 < n.length ? " " : ""),
                                options: a
                ...
                }), o && (console.log("[3/4] inputLines2 (".concat(c.length, ")")), c.forEach(function(e) {
                    return console.log("[3/4] line: ".concat(JSON.stringify(e)))
                })), c.forEach(function(e) {
                    var t = [],
                    a = "";
                    e.forEach(function(e) {
                        a.length + e.text.length > n && (r.push(t), t = [], a = ""),
                        t.push(e),
                        a += e.text.toString()
                    }),
                    0 < t.length && r.push(t)
                }), o && (console.log("[4/4] parsedLines (".concat(r.length, ")")), r.forEach(function(e, t) {
                    return console.log("[4/4] [Line ".concat(t + 1, "]:\n").concat(JSON.stringify(e)))
                }), console.log("...............................................\n\n")), r),
                d.push(s)
            }), f.verbose && console.log("\n| SLIDE [".concat(u.length, "]: ROW [").concat(t, "]: START...")), 0), r = 0, l = !1; ! l;) {
                var c = d[n],
                i = o[n],
                c = (d.forEach(function(e) {
                    e._lineHeight >= r && (r = e._lineHeight)
                }), s < p + r && (f.verbose && (console.log("\n|-----------------------------------------------------------------------|"), console.log("|-- NEW SLIDE CREATED (currTabH+currLineH > maxH) => ".concat((p / F).toFixed(2), " + ").concat((c._lineHeight / F).toFixed(2), " > ").concat(s / F)), console.log("|-----------------------------------------------------------------------|\n\n")), 0 < o.length && 0 < o.map(function(e) {
                    return e.text.length
                }).reduce(function(e, t) {
                    return e + t
                }) && b.rows.push(o), u.push(b), b = {
                    rows: []
                },
                o = [], e.forEach(function(e) {
                ...
                }), h(), p += a + A, f.verbose && console.log("| SLIDE [".concat(u.length, "]: emuSlideTabH ...... = ").concat((s / F).toFixed(1), " ")), p = 0, (f.addHeaderToEach || f.autoPageRepeatHeader) && f._arrObjTabHeadRows && f._arrObjTabHeadRows.forEach(function(e) {
                    var t = [],
                    a = 0;
                    e.forEach(function(e) {
                        t.push(e),
                    ...
                    b.rows.push(t),
                    p += a
                }), i = o[n]), c._lines.shift());
                Array.isArray(i.text) && (c ? i.text = i.text.concat(c) : 0 === i.text.length && (i.text = i.text.concat({
                    _type: N.tablecell,
                    text: ""
                }))),
                n === d.length - 1 && (p += r),
            ...
            f.verbose && console.log("- SLIDE [".concat(u.length, "]: ROW [").concat(t, "]: ...COMPLETE ...... emuTabCurrH = ").concat((p / F).toFixed(2), " ( emuSlideTabH = ").concat((s / F).toFixed(2), " )"))
        }),
        u.push(b),
        f.verbose && (console.log("\n|================================================|"), console.log("| FINAL: tableRowSlides.length = ".concat(u.length)), u.forEach(function(e) {
    ...
    function xe(e, t, a, A) {
        ...
        l = null,
        c = [],
        l = Array.isArray(t) ? (t.forEach(function(e) {
            c = c.concat(e.data)
        }), a || A) : (c = a, A),
        i = (c.forEach(function(e, t) {
            e._dataIndex = t,
        ...
        i.w = i.w || "50%",
        i.h = i.h || "50%",
        i.objectName = i.objectName ? I(i.objectName) : "Chart ".concat(e._slideObjects.filter(function(e) {
            return e._type === N.chart
        }).length),
        ["bar", "col"].includes(i.barDir || "") || (i.barDir = "col"),
        i._type !== v.AREA || ["stacked", "standard", "percentStacked"].includes(i.barGrouping || "") || (i.barGrouping = "standard"),
        i._type !== v.BAR || ["clustered", "stacked", "percentStacked"].includes(i.barGrouping || "") || (i.barGrouping = "clustered"),
        i._type !== v.BAR3D || ["clustered", "stacked", "standard", "percentStacked"].includes(i.barGrouping || "") || (i.barGrouping = "standard"),
        null != (a = i.barGrouping) && a.includes("tacked") && !i.barGapWidthPct && (i.barGapWidthPct = 50),
        i.dataLabelPosition && (i._type !== v.AREA && i._type !== v.BAR3D && i._type !== v.DOUGHNUT && i._type !== v.RADAR || delete i.dataLabelPosition, i._type !== v.PIE || ["bestFit", "ctr", "inEnd", "outEnd"].includes(i.dataLabelPosition) || delete i.dataLabelPosition, i._type !== v.BUBBLE && i._type !== v.BUBBLE3D && i._type !== v.LINE && i._type !== v.SCATTER || ["b", "ctr", "l", "r", "t"].includes(i.dataLabelPosition) || delete i.dataLabelPosition, i._type === v.BAR) && (["stacked", "percentStacked"].includes(i.barGrouping || "") || ["ctr", "inBase", "inEnd"].includes(i.dataLabelPosition) || delete i.dataLabelPosition, ["clustered"].includes(i.barGrouping || "") || ["ctr", "inBase", "inEnd", "outEnd"].includes(i.dataLabelPosition) || delete i.dataLabelPosition),
        i.dataLabelBkgrdColors = !(!i.dataLabelBkgrdColors && i.dataLabelBkgrdColors) && i.dataLabelBkgrdColors,
        ["b", "l", "r", "t", "tr"].includes(i.legendPos || "") || (i.legendPos = "r"),
        ["cone", "coneToMax", "box", "cylinder", "pyramid", "pyramidToMax"].includes(i.bar3DShape || "") || (i.bar3DShape = "box"),
        ["circle", "dash", "diamond", "dot", "none", "square", "triangle"].includes(i.lineDataSymbol || "") || (i.lineDataSymbol = "circle"),
        ["gap", "span"].includes(i.displayBlanksAs || "") || (i.displayBlanksAs = "span"),
        ["standard", "marker", "filled"].includes(i.radarStyle || "") || (i.radarStyle = "standard"),
        i.lineDataSymbolSize = i.lineDataSymbolSize && !isNaN(i.lineDataSymbolSize) ? i.lineDataSymbolSize : 6,
        i.lineDataSymbolLineSize = i.lineDataSymbolLineSize && !isNaN(i.lineDataSymbolLineSize) ? O(i.lineDataSymbolLineSize) : O(.75),
        i.layout && ["x", "y", "w", "h"].forEach(function(e) {
            var t = i.layout[e];
            (isNaN(Number(t)) || t < 0 || 1 < t) && (console.warn("Warning: chart.layout." + e + " can only be 0-1"), delete i.layout[e])
        }),
        i.catGridLine = i.catGridLine || (i._type === v.SCATTER ? {
            color: "D9D9D9",
            size: 1
        } : {
            style: "none"
        }),
        i.valGridLine = i.valGridLine || (i._type === v.SCATTER ? {
            color: "D9D9D9",
            size: 1
        } : {}),
        i.serGridLine = i.serGridLine || (i._type === v.SCATTER ? {
            color: "D9D9D9",
            size: 1
        } : {
            style: "none"
        ...
        o(i.serGridLine),
        be(i.shadow),
        i.showDataTable = !(!i.showDataTable && i.showDataTable) && i.showDataTable,
        i.showDataTableHorzBorder = !(i.showDataTableHorzBorder || !i.showDataTableHorzBorder) || i.showDataTableHorzBorder,
        i.showDataTableVertBorder = !(i.showDataTableVertBorder || !i.showDataTableVertBorder) || i.showDataTableVertBorder,
        i.showDataTableOutline = !(i.showDataTableOutline || !i.showDataTableOutline) || i.showDataTableOutline,
        i.showDataTableKeys = !(i.showDataTableKeys || !i.showDataTableKeys) || i.showDataTableKeys,
        ...
        i.showLeaderLines = !(!i.showLeaderLines && i.showLeaderLines) && i.showLeaderLines,
        ...
        i.v3DRotX = !isNaN(i.v3DRotX) && -90 <= i.v3DRotX && i.v3DRotX <= 90 ? i.v3DRotX : 30,
        i.v3DRotY = !isNaN(i.v3DRotY) && 0 <= i.v3DRotY && i.v3DRotY <= 360 ? i.v3DRotY : 30,
        i.v3DRAngAx = !(i.v3DRAngAx || !i.v3DRAngAx) || i.v3DRAngAx,
        i.v3DPerspective = !isNaN(i.v3DPerspective) && 0 <= i.v3DPerspective && i.v3DPerspective <= 240 ? i.v3DPerspective : 30,
        i.barGapWidthPct = !isNaN(i.barGapWidthPct) && 0 <= i.barGapWidthPct && i.barGapWidthPct <= 1e3 ? i.barGapWidthPct : 150,
        i.barGapDepthPct = !isNaN(i.barGapDepthPct) && 0 <= i.barGapDepthPct && i.barGapDepthPct <= 1e3 ? i.barGapDepthPct : 150,
        i.chartColors = Array.isArray(i.chartColors) ? i.chartColors : i._type === v.PIE || i._type === v.DOUGHNUT ? fe : de,
        i.chartColorsOpacity = i.chartColorsOpacity && !isNaN(i.chartColorsOpacity) ? i.chartColorsOpacity : null,
        i.border = i.border && "object" == typeof i.border ? i.border : null,
        !i.border || i.border.pt && !isNaN(i.border.pt) || (i.border.pt = ee),
        !i.border || i.border.color && "string" == typeof i.border.color || (i.border.color = $),
        i.plotArea = i.plotArea || {},
        i.plotArea.border = i.plotArea.border && "object" == typeof i.plotArea.border ? i.plotArea.border : null,
        !i.plotArea.border || i.plotArea.border.pt && !isNaN(i.plotArea.border.pt) || (i.plotArea.border.pt = ee),
        !i.plotArea.border || i.plotArea.border.color && "string" == typeof i.plotArea.border.color || (i.plotArea.border.color = $),
        ...
        i.chartArea.border = i.chartArea.border && "object" == typeof i.chartArea.border ? i.chartArea.border : null,
        i.chartArea.border && (i.chartArea.border = {
            color: i.chartArea.border.color || $,
            pt: i.chartArea.border.pt || ee
        }),
        i.chartArea.roundedCorners = "boolean" != typeof i.chartArea.roundedCorners || i.chartArea.roundedCorners,
        i.dataBorder = i.dataBorder && "object" == typeof i.dataBorder ? i.dataBorder : null,
        !i.dataBorder || i.dataBorder.pt && !isNaN(i.dataBorder.pt) || (i.dataBorder.pt = .75),
        !i.dataBorder || i.dataBorder.color && "string" == typeof i.dataBorder.color && 6 === i.dataBorder.color.length || (i.dataBorder.color = "F9F9F9"),
        i.dataLabelFormatCode || i._type !== v.SCATTER || (i.dataLabelFormatCode = "General"),
        i.dataLabelFormatCode || i._type !== v.PIE && i._type !== v.DOUGHNUT || (i.dataLabelFormatCode = i.showPercent ? "0%" : "General"),
        i.dataLabelFormatCode = i.dataLabelFormatCode && "string" == typeof i.dataLabelFormatCode ? i.dataLabelFormatCode : "#,##0",
        i.dataLabelFormatScatter || i._type !== v.SCATTER || (i.dataLabelFormatScatter = "custom"),
        i.lineSize = "number" == typeof i.lineSize ? i.lineSize : 2,
        i.valAxisMajorUnit = "number" == typeof i.valAxisMajorUnit ? i.valAxisMajorUnit : null,
        i._type === v.AREA || i._type === v.BAR || i._type === v.BAR3D || i._type === v.LINE ? i.catAxisMultiLevelLabels = !!i.catAxisMultiLevelLabels : delete i.catAxisMultiLevelLabels,
        r._type = "chart",
        r.options = i,
        r.chartRid = g(e),
        e._relsChart.push({
    ...
    function Ce(e, t) {
        ...
        s = t.path || "",
        p = g(e),
        d = t.objectName ? I(t.objectName) : "Image ".concat(e._slideObjects.filter(function(e) {
            return e._type === N.image
        }).length);
        if (s || i) if (s && "string" != typeof s) console.error("ERROR: addImage() 'path' should be a string, ex: {path:'/img/sample.png'} - you sent ".concat(String(s)));
        else
        if (i && "string" != typeof i) console.error("ERROR: addImage() 'data' should be a string, ex: {data:'image/png;base64,NMP[...]'} - you sent ".concat(String(i)));
        else
        if (i && "string" == typeof i && !i.toLowerCase().includes("base64,")) console.error("ERROR: Image `data` value lacks a base64 header! Ex: 'image/png;base64,NMP[...]')");
        else {
            var f = (s.substring(s.lastIndexOf("/") + 1).split("?")[0].split(".").pop().split("#")[0] || "png").toLowerCase();
            if (i && /image\/(\w+);/.exec(i) && 0 < /image\/(\w+);/.exec(i).length ? f = /image\/(\w+);/.exec(i)[1] : null != i && i.toLowerCase().includes("image/svg+xml") && (f = "svg"), a._type = N.image, a.image = s || "preencoded.png", a.options = {
                x: A || 0,
                y: o || 0,
                w: n || 1,
                h: r || 1,
            ...
            "svg" === f ? (e._relsMedia.push({
            ...
            }), a.imageRid = p + 1) : (A = e._relsMedia.filter(function(e) {
                return e.path && e.path === s && e.type === "image/" + f && !e.isDuplicate
            })[0], e._relsMedia.push({
                path: s || "preencoded." + f,
                type: "image/" + f,
                extn: f,
                ...
                Target: null != A && A.Target ? A.Target : "../media/image-".concat(e._slideNum, "-").concat(e._relsMedia.length + 1, ".").concat(f)
            }), a.imageRid = p), "object" == typeof c) {
                if (!c.url && !c.slide) throw new Error("ERROR: `hyperlink` option requires either: `url` or `slide`");
                e._rels.push({
                    type: N.hyperlink,
    ...
    function we(e, t, a) {
        ...
        if (!t) throw new Error("Missing/Invalid shape parameter! Example: `addShape(pptxgen.shapes.LINE, {x:1, y:1, w:1, h:1});`");
        var t = {
        ...
        a.w = a.w || (0 === a.w ? 0 : 1),
        a.h = a.h || (0 === a.h ? 0 : 1),
        a.objectName = a.objectName ? I(a.objectName) : "Shape ".concat(e._slideObjects.filter(function(e) {
            return e._type === N.text
        }).length),
        "string" == typeof a.line && ((t = t).color = String(a.line), a.line = t),
    ...
    function Pe(a, e, t, A) {
        ...
        function n(t) {
            var e;
            return t.placeholder || (t.color = t.color || o.options.color || a.color || w),
            (t.placeholder || A) && (t.bullet = t.bullet || !1),
            (t = t.placeholder && a._slideLayout && a._slideLayout._slideObjects && null != (e = a._slideLayout._slideObjects.filter(function(e) {
                return "placeholder" === e._type && e.options && e.options.placeholder && e.options.placeholder === t.placeholder
            })[0]) && e.options ? y(y({},
            t), e.options) : t).objectName = t.objectName ? I(t.objectName) : "Text ".concat(a._slideObjects.filter(function(e) {
                return e._type === N.text
            }).length),
            t.shape === c.LINE && (e = {
            ...
            "object" == typeof t.line && (t.line = e), "string" == typeof t.line && (e = e, "string" == typeof t.line && (e.color = t.line), t.line = e), "number" == typeof t.lineSize && (t.line.width = t.lineSize), "string" == typeof t.lineDash && (t.line.dashType = t.lineDash), "string" == typeof t.lineHead && (t.line.beginArrowType = t.lineHead), "string" == typeof t.lineTail) && (t.line.endArrowType = t.lineTail),
            t.line = t.line || {},
            ...
            (t.inset && !isNaN(Number(t.inset)) || 0 === t.inset) && (t._bodyProp.lIns = M(t.inset), t._bodyProp.rIns = M(t.inset), t._bodyProp.tIns = M(t.inset), t._bodyProp.bIns = M(t.inset)),
            ...
            0 === (t.valign || "").toLowerCase().indexOf("b") ? t._bodyProp.anchor = l.b : 0 === (t.valign || "").toLowerCase().indexOf("m") ? t._bodyProp.anchor = l.ctr : 0 === (t.valign || "").toLowerCase().indexOf("t") && (t._bodyProp.anchor = l.t),
            be(t.shadow),
            t
        }
    ...
    function Le(e, t) {
        var a, A;
        t.bkgd && (t.background || (t.background = {}), "string" == typeof t.bkgd ? t.background.color = t.bkgd : (t.bkgd.data && (t.background.data = t.bkgd.data), t.bkgd.path && (t.background.path = t.bkgd.path), t.bkgd.src && (t.background.path = t.bkgd.src))),
        null != (a = t.background) && a.fill && (t.background.color = t.background.fill),
        e && (e.path || e.data) && (e.path = e.path || "preencoded.png", "jpg" === (a = (e.path.split(".").pop() || "png").split("?")[0]) && (a = "jpeg"), t._relsMedia = t._relsMedia || [], A = t._relsMedia.length + 1, t._relsMedia.push({
            path: e.path,
            type: N.image,
            extn: a,
            data: e.data || null,
            rId: A,
            Target: "../media/".concat((t._name || "").replace(/\s+/gi, "-"), "-image-").concat(t._relsMedia.length + 1, ".").concat(a)
        }), t._bkgdImgRid = A)
    }
    function m(a, e) {
        var t = [];
        "string" != typeof e && "number" != typeof e && (Array.isArray(e) ? t = e : "object" == typeof e && (t = [e]), t.forEach(function(e) {
            var t;
            Array.isArray(e) ? m(a, e) : Array.isArray(e.text) ? m(a, e.text) : e && "object" == typeof e && e.options && e.options.hyperlink && !e.options.hyperlink._rId && ("object" != typeof e.options.hyperlink ? console.log("ERROR: text `hyperlink` option should be an object. Ex: `hyperlink: {url:'https://github.com'}` ") : e.options.hyperlink.url || e.options.hyperlink.slide ? (t = g(a), a._rels.push({
                type: N.hyperlink,
                data: e.options.hyperlink.slide ? "slide" : "dummy",
                rId: t,
                Target: I(e.options.hyperlink.url) || e.options.hyperlink.slide.toString()
            }), e.options.hyperlink._rId = t) : console.log("ERROR: 'hyperlink requires either: `url` or `slide`'"))
        }))
    }
    ...
    t.prototype.addMedia = function(e) {
        ...
        "online" === p ? (a = g(A), A._relsMedia.push({
            path: s || "preencoded" + t,
            data: "dummy",
            type: "online",
            extn: t,
            rId: a,
            Target: i
        }), u.mediaRid = a, A._relsMedia.push({
            path: "preencoded.png",
            data: d,
            type: "image/png",
            extn: "png",
            rId: g(A),
            Target: "../media/image-".concat(A._slideNum, "-").concat(A._relsMedia.length + 1, ".png")
        })) : (e = A._relsMedia.filter(function(e) {
            return e.path && e.path === s && e.type === p + "/" + t && !e.isDuplicate
        })[0], a = g(A), A._relsMedia.push({
            path: s || "preencoded" + t,
            type: p + "/" + t,
            extn: t,
            data: c || "",
            ...
            Target: null != e && e.Target ? e.Target : "../media/media-".concat(A._slideNum, "-").concat(A._relsMedia.length + 1, ".").concat(t)
        }), u.mediaRid = a, A._relsMedia.push({
            path: s || "preencoded" + t,
            type: p + "/" + t,
            extn: t,
            ...
            rId: g(A),
            isDuplicate: !(null == e || !e.Target),
            Target: null != e && e.Target ? e.Target : "../media/media-".concat(A._slideNum, "-").concat(A._relsMedia.length + 0, ".").concat(t)
        }), A._relsMedia.push({
            path: "preencoded.png",
            type: "image/png",
            extn: "png",
    ...
    t.prototype.addNotes = function(e) {
        return this._slideObjects.push({
            _type: N.notes,
            text: [{
                text: e
            }]
    ...
    t.prototype.addTable = function(e, t) {
        return this._newAutoPagedSlides = function(A, e, t, o, a, n, r) {
            var l, c, i, s = [A],
            p = t && "object" == typeof t ? t : {};
            if (p.objectName = p.objectName ? I(p.objectName) : "Table ".concat(A._slideObjects.filter(function(e) {
                return e._type === N.table
            }).length), null === e || 0 === e.length || !Array.isArray(e)) throw new Error("addTable: Array expected! EX: 'slide.addTable( [rows], {options} );' (https://gitbrent.github.io/PptxGenJS/docs/api-tables.html)");
            if (e[0] && Array.isArray(e[0])) return l = [],
            e.forEach(function(e) {
                var a = [];
                Array.isArray(e) ? e.forEach(function(e) {
                    ...
                    e = ("string" == typeof e || "number" == typeof e ? t.text = e.toString() : e.text && ("string" == typeof e.text || "number" == typeof e.text ? t.text = e.text.toString() : e.text && (t.text = e.text), e.options) && "object" == typeof e.options && (t.options = e.options), t.options.border = t.options.border || p.border || [{
                        type: "none"
                    },
                    {
                        type: "none"
                    ...
                    Array.isArray(e) || "object" != typeof e || (t.options.border = [e, e, e, e]),
                    t.options.border[0] || (t.options.border[0] = {
                        type: "none"
                    }),
                    t.options.border[1] || (t.options.border[1] = {
                        type: "none"
                    }),
                    t.options.border[2] || (t.options.border[2] = {
                        type: "none"
                    }),
                    t.options.border[3] || (t.options.border[3] = {
                        type: "none"
                    });
                    [0, 1, 2, 3].forEach(function(e) {
                        t.options.border[e] = {
                            ...
                            pt: "number" == typeof t.options.border[e].pt ? t.options.border[e].pt : Z
                        }
                    }),
                    a.push(t)
            ...
            "number" == typeof p.margin && (p.margin = [Number(p.margin), Number(p.margin), Number(p.margin), Number(p.margin)]),
            p.color || (p.color = p.color || w),
            "string" == typeof p.border ? (console.warn("addTable `border` option must be an object. Ex: `{border: {type:'none'}}`"), p.border = null) : Array.isArray(p.border) && [0, 1, 2, 3].forEach(function(e) {
            ...
            p.autoPageRepeatHeader = "boolean" == typeof p.autoPageRepeatHeader && p.autoPageRepeatHeader,
            p.autoPageHeaderRows = void 0 === p.autoPageHeaderRows || isNaN(Number(p.autoPageHeaderRows)) ? 1 : Number(p.autoPageHeaderRows),
            p.autoPageLineWeight = void 0 === p.autoPageLineWeight || isNaN(Number(p.autoPageLineWeight)) ? 0 : Number(p.autoPageLineWeight),
            p.autoPageLineWeight && (1 < p.autoPageLineWeight ? p.autoPageLineWeight = 1 : p.autoPageLineWeight < -1 && (p.autoPageLineWeight = -1)),
            c = oe,
            o && void 0 !== o._margin && (Array.isArray(o._margin) ? c = o._margin : isNaN(Number(o._margin)) || (c = [Number(o._margin), Number(o._margin), Number(o._margin), Number(o._margin)])),
            p.colW ? (t = l[0].reduce(function(e, t) {
                var a;
                return null != (a = null == t ? void 0 : t.options) && a.colspan && "number" == typeof t.options.colspan ? e += t.options.colspan : e += 1,
                e
            },
            ...
            l.forEach(function(a) {
                a.forEach(function(e, t) {
                    "number" == typeof e || "string" == typeof e ? a[t] = {
                        _type: N.tablecell,
                        text: String(a[t]),
                        options: p
                    } : "object" == typeof e && ("number" == typeof e.text ? a[t].text = a[t].text.toString() : void 0 !== e.text && null !== e.text || (a[t].text = ""), a[t].options = e.options || {},
                    a[t]._type = N.tablecell)
                })
            }),
            i = [],
            p && !p.autoPage ? (m(A, l), A._slideObjects.push({
                _type: N.table,
                arrTabRows: l,
                options: Object.assign({},
                p)
            })) : (p.autoPageRepeatHeader && (p._arrObjTabHeadRows = l.filter(function(e, t) {
                return t < p.autoPageHeaderRows
            })), ye(l, p, a, o).forEach(function(e, t) {
                r(A._slideNum + t) || s.push(n({
                    masterName: (null == o ? void 0 : o._name) || null
                })),
                0 < t && (p.y = M(p.autoPageSlideStartY || p.newSlideStartY || c[0]));
                var a = r(A._slideNum + t);
                p.autoPage = !1,
                m(a, e.rows),
                a.addTable(e.rows, Object.assign({},
                p)),
                0 < t && i.push(a)
            })),
            i;
    ...
    t.prototype.addText = function(e, t) {
        return Pe(this, "string" == typeof e || "number" == typeof e ? [{
            text: e,
            options: t
        }] : e, t, !1),
        this
    ...
    function t(e) {
        ...
        this._slideObjects = [],
        this._slideNumberProps = null != (e = this._slideLayout) && e._slideNumberProps ? this._slideLayout._slideNumberProps : null
    }
    function Te(m, b) {
                ...
                case 0:
                    ...
                    default,
                        ...
                        if (p += "<sheetData>", c) {
                            ...
                            for (var d = 0; d < g.length; d++) p += '<c r="'.concat(B(d + 1 + g[0].labels.length), '1" t="s"><v>').concat(d + 1, "</v></c>");
                            p += "</row>",
                            g[0].labels[0].forEach(function(e, t) {
                                p += '<row r="'.concat(t + 2, '" spans="1:').concat(g.length + g[0].labels.length, '">');
                                for (var a = g[0].labels.length - 1; 0 <= a; a--) p = (p += '<c r="'.concat(B(g[0].labels.length - a)).concat(t + 2, '" t="s">')) + "<v>".concat(g.length + t + 1, "</v>") + "</c>";
                                for (var A = 0; A < g.length; A++) p += '<c r="'.concat(B(g[0].labels.length + A + 1)).concat(t + 2, '"><v>').concat(g[A].values[t] || "", "</v></c>");
                                p += "</row>"
                            })
                        }
                        p += '</sheetData><pageMargins left="0.7" right="0.7" top="0.75" bottom="0.75" header="0.3" footer="0.3"/></worksheet>\n',
                        r.file("xl/worksheets/sheet1.xml", p),
                        r.generateAsync({
                            type: "base64"
                        }).then(function(e) {
                            b.file("ppt/embeddings/Microsoft_Excel_Worksheet".concat(m.globalId, ".xlsx"), e, {
                                base64: !0
                            }),
                            b.file("ppt/charts/_rels/" + m.fileName + ".rels", '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">' + '<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/package" Target="../embeddings/Microsoft_Excel_Worksheet'.concat(m.globalId, '.xlsx"/>') + "</Relationships>"),
                            b.file("ppt/charts/".concat(m.fileName), function(o) {
                                var e, n = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>',
                                r = !1;
                                n = (n += '<c:chartSpace xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><c:date1904 val="0"/>') + '<c:roundedCorners val="'.concat(o.opts.chartArea.roundedCorners ? "1" : "0", '"/>') + "<c:chart>",
                                o.opts.showTitle ? n = n + Ne({
                                ...
                                o.opts.x, o.opts.y) + '<c:autoTitleDeleted val="0"/>': n += '<c:autoTitleDeleted val="1"/>';
                                o.opts._type === v.BAR3D && (n += '<c:view3D><c:rotX val="'.concat(o.opts.v3DRotX, '"/><c:rotY val="').concat(o.opts.v3DRotY, '"/><c:rAngAx val="').concat(o.opts.v3DRAngAx ? 1 : 0, '"/><c:perspective val="').concat(o.opts.v3DPerspective, '"/></c:view3D>'));
                                n += "<c:plotArea>",
                                o.opts.layout ? n = (n = (n = (n = (n = (n = (n = (n += "<c:layout>") + ' <c:manualLayout>  <c:layoutTarget val="inner" />') + '  <c:xMode val="edge" />  <c:yMode val="edge" />') + '  <c:x val="' + (o.opts.layout.x || 0) + '" />') + '  <c:y val="' + (o.opts.layout.y || 0) + '" />') + '  <c:w val="' + (o.opts.layout.w || 1) + '" />') + '  <c:h val="' + (o.opts.layout.h || 1) + '" />') + " </c:manualLayout></c:layout>": n += "<c:layout/>";
                                Array.isArray(o.opts._type) ? o.opts._type.forEach(function(e) {
                                    var t = y(y({},
                                    o.opts), e.options),
                                ...
                                }) : n += De(o.opts._type, o.data, o.opts, L, ce);
                                if (o.opts._type !== v.PIE && o.opts._type !== v.DOUGHNUT) {
                                    if (o.opts.valAxes && 1 < o.opts.valAxes.length && !r) throw new Error("Secondary axis must be used by one of the multiple charts");
                                    if (o.opts.catAxes) {
                                        if (!o.opts.valAxes || o.opts.valAxes.length !== o.opts.catAxes.length) throw new Error("There must be the same number of value and category axes.");
                                        n += Se(y(y({},
                                        o.opts), o.opts.catAxes[0]), ce, L)
                                    } else n += Se(o.opts, ce, L);
                                    o.opts.valAxes ? (n += Ee(y(y({},
                                    o.opts), o.opts.valAxes[0]), L), o.opts.valAxes[1] && (n += Ee(y(y({},
                                    o.opts), o.opts.valAxes[1]), le))) : (n += Ee(o.opts, L), o.opts._type === v.BAR3D && (n += function(t, e, a) {
                                        var A = "";
                                        A = (A = (A = (A = (A = A + '<c:serAx>  <c:axId val="' + e + '"/>') + '  <c:scaling><c:orientation val="' + (t.serAxisOrientation || (t.barDir, "minMax")) + '"/></c:scaling>') + '  <c:delete val="' + (t.serAxisHidden ? "1" : "0") + '"/>') + '  <c:axPos val="' + ("col" === t.barDir ? "b" : "l") + '"/>') + ("none" !== t.serGridLine.style ? Fe(t.serGridLine) : ""),
                                        t.showSerAxisTitle && (A += Ne({
                                        ...
                                        A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A += '  <c:numFmt formatCode="'.concat(I(t.serLabelFormatCode) || "General", '" sourceLinked="0"/>')) + '  <c:majorTickMark val="out"/>  <c:minorTickMark val="none"/>') + '  <c:tickLblPos val="'.concat(t.serAxisLabelPos || "col" === t.barDir ? "low" : "nextTo", '"/>')) + '  <c:spPr>    <a:ln w="12700" cap="flat">') + (t.serAxisLineShow ? "<a:solidFill>".concat(z(t.serAxisLineColor || C.color), "</a:solidFill>") : "<a:noFill/>") + '      <a:prstDash val="solid"/>') + "      <a:round/>    </a:ln>") + "  </c:spPr>  <c:txPr>") + "    <a:bodyPr/>    <a:lstStyle/>") + "    <a:p>    <a:pPr>") + '    <a:defRPr sz="'.concat(Math.round(100 * (t.serAxisLabelFontSize || P)), '" b="').concat(t.serAxisLabelFontBold ? "1" : "0", '" i="').concat(t.serAxisLabelFontItalic ? "1" : "0", '" u="none" strike="noStrike">')) + "      <a:solidFill>".concat(z(t.serAxisLabelColor || w), "</a:solidFill>")) + '      <a:latin typeface="'.concat(t.serAxisLabelFontFace || "Arial", '"/>')) + "   </a:defRPr>  </a:pPr>") + '  <a:endParaRPr lang="' + (t.lang || "en-US") + '"/>') + "  </a:p> </c:txPr>") + ' <c:crossAx val="' + a + '"/> <c:crosses val="autoZero"/>',
                                        t.serAxisLabelFrequency && (A += ' <c:tickLblSkip val="' + t.serAxisLabelFrequency + '"/>');
                                        t.serLabelFormatCode && (["serAxisBaseTimeUnit", "serAxisMajorTimeUnit", "serAxisMinorTimeUnit"].forEach(function(e) { ! t[e] || "string" == typeof t[e] && ["days", "months", "years"].includes(e.toLowerCase()) || (console.warn('"'.concat(e, "\" must be one of: 'days','months','years' !")), t[e] = null)
                                        }), t.serAxisBaseTimeUnit && (A += ' <c:baseTimeUnit  val="'.concat(t.serAxisBaseTimeUnit.toLowerCase(), '"/>')), t.serAxisMajorTimeUnit && (A += ' <c:majorTimeUnit val="'.concat(t.serAxisMajorTimeUnit.toLowerCase(), '"/>')), t.serAxisMinorTimeUnit && (A += ' <c:minorTimeUnit val="'.concat(t.serAxisMinorTimeUnit.toLowerCase(), '"/>')), t.serAxisMajorUnit && (A += ' <c:majorUnit val="'.concat(t.serAxisMajorUnit, '"/>')), t.serAxisMinorUnit) && (A += ' <c:minorUnit val="'.concat(t.serAxisMinorUnit, '"/>'));
                                        return A += "</c:serAx>"
                                    } (o.opts, se, L))),
                                    null != (e = o.opts) && e.catAxes && null != (e = o.opts) && e.catAxes[1] && (n += Se(y(y({},
                                    o.opts), o.opts.catAxes[1]), ie, le))
                                }
                                o.opts.showDataTable && (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n += "<c:dTable>") + '  <c:showHorzBorder val="'.concat(o.opts.showDataTableHorzBorder ? 1 : 0, '"/>')) + '  <c:showVertBorder val="'.concat(o.opts.showDataTableVertBorder ? 1 : 0, '"/>')) + '  <c:showOutline    val="'.concat(o.opts.showDataTableOutline ? 1 : 0, '"/>')) + '  <c:showKeys       val="'.concat(o.opts.showDataTableKeys ? 1 : 0, '"/>')) + "  <c:spPr>    <a:noFill/>") + '    <a:ln w="9525" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="tx1"><a:lumMod val="15000"/><a:lumOff val="85000"/></a:schemeClr></a:solidFill><a:round/></a:ln>    <a:effectLst/>') + "  </c:spPr>  <c:txPr>") + '   <a:bodyPr rot="0" spcFirstLastPara="1" vertOverflow="ellipsis" vert="horz" wrap="square" anchor="ctr" anchorCtr="1"/>   <a:lstStyle/>') + '   <a:p>     <a:pPr rtl="0">') + '       <a:defRPr sz="'.concat(Math.round(100 * (o.opts.dataTableFontSize || P)), '" b="0" i="0" u="none" strike="noStrike" kern="1200" baseline="0">')) + '         <a:solidFill><a:schemeClr val="tx1"><a:lumMod val="65000"/><a:lumOff val="35000"/></a:schemeClr></a:solidFill>         <a:latin typeface="+mn-lt"/>') + '         <a:ea typeface="+mn-ea"/>         <a:cs typeface="+mn-cs"/>') + "       </a:defRPr>     </a:pPr>") + '    <a:endParaRPr lang="en-US"/>   </a:p>') + " </c:txPr></c:dTable>");
                                n = (n = (n = (n += "  <c:spPr>") + (null != (e = o.opts.plotArea.fill) && e.color ? U(o.opts.plotArea.fill) : "<a:noFill/>")) + (o.opts.plotArea.border ? '<a:ln w="'.concat(O(o.opts.plotArea.border.pt), '" cap="flat">').concat(U(o.opts.plotArea.border.color), "</a:ln>") : "<a:ln><a:noFill/></a:ln>") + "    <a:effectLst/>") + "  </c:spPr></c:plotArea>",
                                o.opts.showLegend && (n = (n += "<c:legend>") + '<c:legendPos val="' + o.opts.legendPos + '"/><c:overlay val="0"/>', (o.opts.legendFontFace || o.opts.legendFontSize || o.opts.legendColor) && (n = (n = (n = (n += "<c:txPr>") + "  <a:bodyPr/>  <a:lstStyle/>") + "  <a:p>    <a:pPr>") + (o.opts.legendFontSize ? '<a:defRPr sz="'.concat(Math.round(100 * Number(o.opts.legendFontSize)), '">') : "<a:defRPr>"), o.opts.legendColor && (n += U(o.opts.legendColor)), o.opts.legendFontFace && (n += '<a:latin typeface="' + o.opts.legendFontFace + '"/>'), o.opts.legendFontFace && (n += '<a:cs    typeface="' + o.opts.legendFontFace + '"/>'), n = (n = (n += "      </a:defRPr>") + '    </a:pPr>    <a:endParaRPr lang="en-US"/>') + "  </a:p></c:txPr>"), n += "</c:legend>");
                                n = (n += '  <c:plotVisOnly val="1"/>') + '  <c:dispBlanksAs val="' + o.opts.displayBlanksAs + '"/>',
                                o.opts._type === v.SCATTER && (n += '<c:showDLblsOverMax val="1"/>');
                                return n = (n = (n = (n = (n += "</c:chart><c:spPr>") + (null != (e = o.opts.chartArea.fill) && e.color ? U(o.opts.chartArea.fill) : "<a:noFill/>")) + (o.opts.chartArea.border ? '<a:ln w="'.concat(O(o.opts.chartArea.border.pt), '" cap="flat">').concat(U(o.opts.chartArea.border.color), "</a:ln>") : "<a:ln><a:noFill/></a:ln>")) + "  <a:effectLst/></c:spPr>") + '<c:externalData r:id="rId1"><c:autoUpdate val="0"/></c:externalData></c:chartSpace>'
                            } (m)),
                            t("")
                        }).
                        catch(function(e) {
    ...
    function De(A, o, n, e, t) {
        ...
        case v.AREA:
            ...
            case v.RADAR:
            c += "<c:".concat(A, "Chart>"),
            A === v.AREA && "stacked" === n.barGrouping && (c += '<c:grouping val="' + n.barGrouping + '"/>'),
            A !== v.BAR && A !== v.BAR3D || (c = (c += '<c:barDir val="' + n.barDir + '"/>') + '<c:grouping val="' + (n.barGrouping || "clustered") + '"/>'),
            A === v.RADAR && (c += '<c:radarStyle val="' + n.radarStyle + '"/>'),
            c += '<c:varyColors val="0"/>',
            o.forEach(function(e) {
                r++,
                c = (c = (c = (c += "<c:ser>") + '  <c:idx val="'.concat(e._dataIndex, '"/><c:order val="').concat(e._dataIndex, '"/>') + "  <c:tx>    <c:strRef>") + "      <c:f>Sheet1!$" + B(e._dataIndex + e.labels.length + 1) + "$1</c:f>") + '      <c:strCache><c:ptCount val="1"/><c:pt idx="0"><c:v>' + I(e.name) + "</c:v></c:pt></c:strCache>    </c:strRef>  </c:tx>";
                var t = n.chartColors ? n.chartColors[r % n.chartColors.length] : null;
                c += "  <c:spPr>",
                "transparent" === t ? c += "<a:noFill/>": n.chartColorsOpacity ? c += "<a:solidFill>" + z(t, '<a:alpha val="'.concat(Math.round(1e3 * n.chartColorsOpacity), '"/>')) + "</a:solidFill>": c += "<a:solidFill>" + z(t) + "</a:solidFill>",
                A === v.LINE || A === v.RADAR ? 0 === n.lineSize ? c += "<a:ln><a:noFill/></a:ln>": c = (c += '<a:ln w="'.concat(O(n.lineSize), '" cap="').concat(Re(n.lineCap), '"><a:solidFill>').concat(z(t), "</a:solidFill>")) + ('<a:prstDash val="' + (n.lineDash || "solid")) + '"/><a:round/></a:ln>': n.dataBorder && (c += '<a:ln w="'.concat(O(n.dataBorder.pt), '" cap="').concat(Re(n.lineCap), '"><a:solidFill>').concat(z(n.dataBorder.color), '</a:solidFill><a:prstDash val="solid"/><a:round/></a:ln>')),
                c = c + b(n.shadow, s) + '  </c:spPr>  <c:invertIfNegative val="0"/>',
                A !== v.RADAR && (c = (c += "<c:dLbls>") + '<c:numFmt formatCode="'.concat(I(n.dataLabelFormatCode) || "General", '" sourceLinked="0"/>'), n.dataLabelBkgrdColors && (c += "<c:spPr><a:solidFill>".concat(z(t), "</a:solidFill></c:spPr>")), c = (c = (c = (c += "<c:txPr><a:bodyPr/><a:lstStyle/><a:p><a:pPr>") + '<a:defRPr b="'.concat(n.dataLabelFontBold ? 1 : 0, '" i="').concat(n.dataLabelFontItalic ? 1 : 0, '" strike="noStrike" sz="').concat(Math.round(100 * (n.dataLabelFontSize || P)), '" u="none">')) + "<a:solidFill>".concat(z(n.dataLabelColor || w), "</a:solidFill>")) + '<a:latin typeface="'.concat(n.dataLabelFontFace || "Arial", '"/>') + "</a:defRPr></a:pPr></a:p></c:txPr>", n.dataLabelPosition && (c += '<c:dLblPos val="'.concat(n.dataLabelPosition, '"/>')), c = (c = (c = (c += '<c:showLegendKey val="0"/>') + '<c:showVal val="'.concat(n.showValue ? "1" : "0", '"/>')) + '<c:showCatName val="0"/><c:showSerName val="'.concat(n.showSerName ? "1" : "0", '"/><c:showPercent val="0"/><c:showBubbleSize val="0"/>')) + '<c:showLeaderLines val="'.concat(n.showLeaderLines ? "1" : "0", '"/>') + "</c:dLbls>"),
                A !== v.LINE && A !== v.RADAR || (c = (c += "<c:marker>") + '  <c:symbol val="' + n.lineDataSymbol + '"/>', n.lineDataSymbolSize && (c += '<c:size val="'.concat(n.lineDataSymbolSize, '"/>')), c = (c = (c += "  <c:spPr>") + "    <a:solidFill>".concat(z(n.chartColors[e._dataIndex + 1 > n.chartColors.length ? Math.floor(Math.random() * n.chartColors.length) : e._dataIndex]), "</a:solidFill>")) + '    <a:ln w="'.concat(n.lineDataSymbolLineSize, '" cap="flat"><a:solidFill>').concat(z(n.lineDataSymbolLineColor || t), '</a:solidFill><a:prstDash val="solid"/><a:round/></a:ln>') + "    <a:effectLst/>  </c:spPr></c:marker>"),
                A !== v.BAR && A !== v.BAR3D || 1 !== o.length || !(n.chartColors && n.chartColors !== de && 1 < n.chartColors.length || null != (t = n.invertedColors) && t.length) || e.values.forEach(function(e, t) {
                    e = e < 0 ? n.invertedColors || n.chartColors || de : n.chartColors || [];
                    c = (c += "  <c:dPt>") + '    <c:idx val="'.concat(t, '"/>') + '      <c:invertIfNegative val="0"/>    <c:bubble3D val="0"/>    <c:spPr>',
                    0 === n.lineSize ? c += "<a:ln><a:noFill/></a:ln>": c = A === v.BAR ? (c += "<a:solidFill>") + '  <a:srgbClr val="' + e[t % e.length] + '"/></a:solidFill>': (c += "<a:ln>  <a:solidFill>") + '   <a:srgbClr val="' + e[t % e.length] + '"/>  </a:solidFill></a:ln>',
                    c = c + b(n.shadow, s) + "    </c:spPr>  </c:dPt>"
                }),
                c += "<c:cat>",
                n.catLabelFormatCode ? (c = (c = (c = (c += "  <c:numRef>") + "    <c:f>Sheet1!$A$2:$A$".concat(e.labels[0].length + 1, "</c:f>") + "    <c:numCache>") + "      <c:formatCode>" + (n.catLabelFormatCode || "General") + "</c:formatCode>") + '      <c:ptCount val="'.concat(e.labels[0].length, '"/>'), e.labels[0].forEach(function(e, t) {
                    return c += '<c:pt idx="'.concat(t, '"><c:v>').concat(I(e), "</c:v></c:pt>")
                }), c += "    </c:numCache>  </c:numRef>") : (c = (c = (c += "  <c:multiLvlStrRef>") + "    <c:f>Sheet1!$A$2:$".concat(B(e.labels.length), "$").concat(e.labels[0].length + 1, "</c:f>") + "    <c:multiLvlStrCache>") + '      <c:ptCount val="'.concat(e.labels[0].length, '"/>'), e.labels.forEach(function(e) {
                    c += "<c:lvl>",
                ...
                c = (c = (c = (c = c + "</c:cat>" + "<c:val>  <c:numRef>") + "<c:f>Sheet1!$".concat(B(e._dataIndex + e.labels.length + 1), "$2:$").concat(B(e._dataIndex + e.labels.length + 1), "$").concat(e.labels[0].length + 1, "</c:f>") + "    <c:numCache>") + "      <c:formatCode>" + (n.valLabelFormatCode || n.dataTableFormatCode || "General") + "</c:formatCode>") + '      <c:ptCount val="'.concat(e.labels[0].length, '"/>'),
                e.values.forEach(function(e, t) {
                    return c += '<c:pt idx="'.concat(t, '"><c:v>').concat(e || 0 === e ? e : "", "</c:v></c:pt>")
                }),
                c += "    </c:numCache>  </c:numRef></c:val>",
                A === v.LINE && (c += '<c:smooth val="' + (n.lineSmooth ? "1" : "0") + '"/>'),
                c += "</c:ser>"
            }),
            c = (c = (c = (c = (c += "  <c:dLbls>") + '    <c:numFmt formatCode="'.concat(I(n.dataLabelFormatCode) || "General", '" sourceLinked="0"/>') + "    <c:txPr>      <a:bodyPr/>      <a:lstStyle/>      <a:p><a:pPr>") + '        <a:defRPr b="'.concat(n.dataLabelFontBold ? 1 : 0, '" i="').concat(n.dataLabelFontItalic ? 1 : 0, '" strike="noStrike" sz="').concat(Math.round(100 * (n.dataLabelFontSize || P)), '" u="none">')) + "          <a:solidFill>" + z(n.dataLabelColor || w) + "</a:solidFill>") + '          <a:latin typeface="' + (n.dataLabelFontFace || "Arial") + '"/>        </a:defRPr>      </a:pPr></a:p>    </c:txPr>',
            n.dataLabelPosition && (c += ' <c:dLblPos val="' + n.dataLabelPosition + '"/>'),
            c = (c = (c = (c += '    <c:showLegendKey val="0"/>') + '    <c:showVal val="' + (n.showValue ? "1" : "0") + '"/>    <c:showCatName val="0"/>') + '    <c:showSerName val="' + (n.showSerName ? "1" : "0") + '"/>    <c:showPercent val="0"/>    <c:showBubbleSize val="0"/>') + '    <c:showLeaderLines val="'.concat(n.showLeaderLines ? "1" : "0", '"/>') + "  </c:dLbls>",
            A === v.BAR ? c = (c += '  <c:gapWidth val="'.concat(n.barGapWidthPct, '"/>')) + '  <c:overlap val="'.concat((n.barGrouping || "").includes("tacked") ? 100 : n.barOverlapPct || 0, '"/>') : A === v.BAR3D ? c = (c = (c += '  <c:gapWidth val="'.concat(n.barGapWidthPct, '"/>')) + '  <c:gapDepth val="'.concat(n.barGapDepthPct, '"/>')) + ('  <c:shape val="' + n.bar3DShape) + '"/>' : A === v.LINE && (c += '  <c:marker val="1"/>'),
            c = (c += '<c:axId val="'.concat(t, '"/><c:axId val="').concat(e, '"/><c:axId val="').concat(se, '"/>')) + "</c:".concat(A, "Chart>");
            break;
        case v.SCATTER:
            c = (c += "<c:" + A + "Chart>") + '<c:scatterStyle val="lineMarker"/>' + '<c:varyColors val="0"/>',
            r = -1,
            o.filter(function(e, t) {
                return 0 < t
            }).forEach(function(a, e) {
                r++,
                c = (c = (c = (c = (c += "<c:ser>") + '  <c:idx val="'.concat(e, '"/>')) + '  <c:order val="'.concat(e, '"/>') + "  <c:tx>    <c:strRef>") + "      <c:f>Sheet1!$".concat(B(e + 2), "$1</c:f>")) + '      <c:strCache><c:ptCount val="1"/><c:pt idx="0"><c:v>' + I(a.name) + "</c:v></c:pt></c:strCache>    </c:strRef>  </c:tx>  <c:spPr>";
                var A, t = n.chartColors[r % n.chartColors.length];
                "transparent" === t ? c += "<a:noFill/>": n.chartColorsOpacity ? c += "<a:solidFill>" + z(t, '<a:alpha val="' + Math.round(1e3 * n.chartColorsOpacity).toString() + '"/>') + "</a:solidFill>": c += "<a:solidFill>" + z(t) + "</a:solidFill>",
                0 === n.lineSize ? c += "<a:ln><a:noFill/></a:ln>": c = (c += '<a:ln w="'.concat(O(n.lineSize), '" cap="').concat(Re(n.lineCap), '"><a:solidFill>').concat(z(t), "</a:solidFill>")) + '<a:prstDash val="'.concat(n.lineDash || "solid", '"/><a:round/></a:ln>'),
                c = (c = (c += b(n.shadow, s)) + "  </c:spPr>" + "<c:marker>") + '  <c:symbol val="' + n.lineDataSymbol + '"/>',
                n.lineDataSymbolSize && (c += '<c:size val="'.concat(n.lineDataSymbolSize, '"/>')),
                c = (c = (c += "<c:spPr>") + "<a:solidFill>".concat(z(n.chartColors[e + 1 > n.chartColors.length ? Math.floor(Math.random() * n.chartColors.length) : e]), "</a:solidFill>")) + '<a:ln w="'.concat(n.lineDataSymbolLineSize, '" cap="flat"><a:solidFill>').concat(z(n.lineDataSymbolLineColor || n.chartColors[r % n.chartColors.length]), '</a:solidFill><a:prstDash val="solid"/><a:round/></a:ln>') + "<a:effectLst/></c:spPr></c:marker>",
                n.showLabel && (A = he("-xxxx-xxxx-xxxx-xxxxxxxxxxxx"), !a.labels[0] || "custom" !== n.dataLabelFormatScatter && "customXY" !== n.dataLabelFormatScatter || (c += "<c:dLbls>", a.labels[0].forEach(function(e, t) {
                ...
                }), c += "</c:dLbls>"), "XY" === n.dataLabelFormatScatter) && (c += '<c:dLbls>    <c:spPr>        <a:noFill/>        <a:ln>            <a:noFill/>        </a:ln>          <a:effectLst/>    </c:spPr>    <c:txPr>        <a:bodyPr>            <a:spAutoFit/>        </a:bodyPr>        <a:lstStyle/>        <a:p>            <a:pPr>                <a:defRPr/>            </a:pPr>            <a:endParaRPr lang="en-US"/>        </a:p>    </c:txPr>', n.dataLabelPosition && (c += ' <c:dLblPos val="' + n.dataLabelPosition + '"/>'), c = (c = (c = (c += '    <c:showLegendKey val="0"/>') + ' <c:showVal val="'.concat(n.showLabel ? "1" : "0", '"/>')) + ' <c:showCatName val="'.concat(n.showLabel ? "1" : "0", '"/>')) + ' <c:showSerName val="'.concat(n.showSerName ? "1" : "0", '"/>') + '    <c:showPercent val="0"/>    <c:showBubbleSize val="0"/>    <c:extLst>        <c:ext uri="{CE6537A1-D6FC-4f65-9D91-7224C49458BB}" xmlns:c15="http://schemas.microsoft.com/office/drawing/2012/chart">            <c15:showLeaderLines val="1"/>        </c:ext>    </c:extLst></c:dLbls>'),
                1 === o.length && n.chartColors !== de && a.values.forEach(function(e, t) {
                    e = e < 0 ? n.invertedColors || n.chartColors || de : n.chartColors || [];
                    c = (c += "  <c:dPt>") + '    <c:idx val="'.concat(t, '"/>') + '      <c:invertIfNegative val="0"/>    <c:bubble3D val="0"/>    <c:spPr>',
                    0 === n.lineSize ? c += "<a:ln><a:noFill/></a:ln>": c = (c += "<a:solidFill>") + ' <a:srgbClr val="' + e[t % e.length] + '"/></a:solidFill>',
                    c = c + b(n.shadow, s) + "    </c:spPr>  </c:dPt>"
                }),
                c = (c = (c += "<c:xVal>  <c:numRef>") + "    <c:f>Sheet1!$A$2:$A$".concat(o[0].values.length + 1, "</c:f>") + "    <c:numCache>      <c:formatCode>General</c:formatCode>") + '      <c:ptCount val="'.concat(o[0].values.length, '"/>'),
                o[0].values.forEach(function(e, t) {
                    c += '<c:pt idx="'.concat(t, '"><c:v>').concat(e || 0 === e ? e : "", "</c:v></c:pt>")
                }),
                c = (c = (c += "    </c:numCache>  </c:numRef></c:xVal><c:yVal>  <c:numRef>") + "    <c:f>Sheet1!$".concat(B(e + 2), "$2:$").concat(B(e + 2), "$").concat(o[0].values.length + 1, "</c:f>") + "    <c:numCache>      <c:formatCode>General</c:formatCode>") + '      <c:ptCount val="'.concat(o[0].values.length, '"/>'),
                o[0].values.forEach(function(e, t) {
                    c += '<c:pt idx="'.concat(t, '"><c:v>').concat(a.values[t] || 0 === a.values[t] ? a.values[t] : "", "</c:v></c:pt>")
                }),
                c = (c += "    </c:numCache>  </c:numRef></c:yVal>") + '<c:smooth val="' + (n.lineSmooth ? "1" : "0") + '"/></c:ser>'
            }),
            c = (c = (c = (c = (c += "  <c:dLbls>") + '    <c:numFmt formatCode="'.concat(I(n.dataLabelFormatCode) || "General", '" sourceLinked="0"/>') + "    <c:txPr>      <a:bodyPr/>      <a:lstStyle/>      <a:p><a:pPr>") + '        <a:defRPr b="'.concat(n.dataLabelFontBold ? "1" : "0", '" i="').concat(n.dataLabelFontItalic ? "1" : "0", '" strike="noStrike" sz="').concat(Math.round(100 * (n.dataLabelFontSize || P)), '" u="none">')) + "          <a:solidFill>" + z(n.dataLabelColor || w) + "</a:solidFill>") + '          <a:latin typeface="' + (n.dataLabelFontFace || "Arial") + '"/>        </a:defRPr>      </a:pPr></a:p>    </c:txPr>',
            n.dataLabelPosition && (c += ' <c:dLblPos val="' + n.dataLabelPosition + '"/>'),
            c = (c = (c += '    <c:showLegendKey val="0"/>') + '    <c:showVal val="' + (n.showValue ? "1" : "0") + '"/>    <c:showCatName val="0"/>') + '    <c:showSerName val="' + (n.showSerName ? "1" : "0") + '"/>    <c:showPercent val="0"/>    <c:showBubbleSize val="0"/>  </c:dLbls>',
            c = (c += '<c:axId val="'.concat(t, '"/><c:axId val="').concat(e, '"/>')) + ("</c:" + A + "Chart>");
            break;
        case v.BUBBLE:
            case v.BUBBLE3D:
            ...
            o.filter(function(e, t) {
                ...
                r++,
                c = (c = (c = (c = (c += "<c:ser>") + '  <c:idx val="'.concat(e, '"/>')) + '  <c:order val="'.concat(e, '"/>') + "  <c:tx>    <c:strRef>") + "      <c:f>Sheet1!$" + B(l + 1) + "$1</c:f>") + '      <c:strCache><c:ptCount val="1"/><c:pt idx="0"><c:v>' + I(a.name) + "</c:v></c:pt></c:strCache>    </c:strRef>  </c:tx><c:spPr>";
                e = n.chartColors[r % n.chartColors.length];
                "transparent" === e ? c += "<a:noFill/>": n.chartColorsOpacity ? c += "<a:solidFill>".concat(z(e, '<a:alpha val="' + Math.round(1e3 * n.chartColorsOpacity).toString() + '"/>'), "</a:solidFill>") : c += "<a:solidFill>" + z(e) + "</a:solidFill>",
                0 === n.lineSize ? c += "<a:ln><a:noFill/></a:ln>": n.dataBorder ? c += '<a:ln w="'.concat(O(n.dataBorder.pt), '" cap="flat"><a:solidFill>').concat(z(n.dataBorder.color), '</a:solidFill><a:prstDash val="solid"/><a:round/></a:ln>') : c = (c += '<a:ln w="'.concat(O(n.lineSize), '" cap="flat"><a:solidFill>').concat(z(e), "</a:solidFill>")) + '<a:prstDash val="'.concat(n.lineDash || "solid", '"/><a:round/></a:ln>'),
                c = c + b(n.shadow, s) + "</c:spPr>",
                c = (c = (c += "<c:xVal>  <c:numRef>") + "    <c:f>Sheet1!$A$2:$A$".concat(o[0].values.length + 1, "</c:f>") + "    <c:numCache>      <c:formatCode>General</c:formatCode>") + '      <c:ptCount val="'.concat(o[0].values.length, '"/>'),
                o[0].values.forEach(function(e, t) {
                    c += '<c:pt idx="'.concat(t, '"><c:v>').concat(e || 0 === e ? e : "", "</c:v></c:pt>")
                }),
                c = (c += "    </c:numCache>  </c:numRef></c:xVal><c:yVal>  <c:numRef>") + "<c:f>Sheet1!$".concat(B(l + 1), "$2:$").concat(B(l + 1), "$").concat(o[0].values.length + 1, "</c:f>"),
                l++,
                c = (c += "    <c:numCache>      <c:formatCode>General</c:formatCode>") + '      <c:ptCount val="'.concat(o[0].values.length, '"/>'),
                o[0].values.forEach(function(e, t) {
                    c += '<c:pt idx="'.concat(t, '"><c:v>').concat(a.values[t] || 0 === a.values[t] ? a.values[t] : "", "</c:v></c:pt>")
                }),
                c = (c += "    </c:numCache>  </c:numRef></c:yVal>  <c:bubbleSize>    <c:numRef>") + "<c:f>Sheet1!$".concat(B(l + 1), "$2:$").concat(B(l + 1), "$").concat(a.sizes.length + 1, "</c:f>"),
                l++,
                c = (c += "      <c:numCache>        <c:formatCode>General</c:formatCode>") + '           <c:ptCount val="'.concat(a.sizes.length, '"/>'),
                a.sizes.forEach(function(e, t) {
                    c += '<c:pt idx="'.concat(t, '"><c:v>').concat(e || "", "</c:v></c:pt>")
                }),
                c = (c += "      </c:numCache>    </c:numRef>  </c:bubbleSize>") + '  <c:bubble3D val="' + (A === v.BUBBLE3D ? "1" : "0") + '"/></c:ser>'
            }),
            c = (c = (c = (c = (c += "<c:dLbls>") + '<c:numFmt formatCode="'.concat(I(n.dataLabelFormatCode) || "General", '" sourceLinked="0"/>') + "<c:txPr><a:bodyPr/><a:lstStyle/><a:p><a:pPr>") + '<a:defRPr b="'.concat(n.dataLabelFontBold ? 1 : 0, '" i="').concat(n.dataLabelFontItalic ? 1 : 0, '" strike="noStrike" sz="').concat(Math.round(100 * Math.round(n.dataLabelFontSize || P)), '" u="none">')) + "<a:solidFill>".concat(z(n.dataLabelColor || w), "</a:solidFill>")) + '<a:latin typeface="'.concat(n.dataLabelFontFace || "Arial", '"/>') + "</a:defRPr></a:pPr></a:p></c:txPr>",
            n.dataLabelPosition && (c += '<c:dLblPos val="'.concat(n.dataLabelPosition, '"/>')),
            c = (c = (c = (c = (c += '<c:showLegendKey val="0"/>') + '<c:showVal val="'.concat(n.showValue ? "1" : "0", '"/>')) + '<c:showCatName val="0"/><c:showSerName val="'.concat(n.showSerName ? "1" : "0", '"/><c:showPercent val="0"/><c:showBubbleSize val="0"/>') + '<c:extLst>  <c:ext uri="{CE6537A1-D6FC-4f65-9D91-7224C49458BB}" xmlns:c15="http://schemas.microsoft.com/office/drawing/2012/chart">') + '    <c15:showLeaderLines val="' + (n.showLeaderLines ? "1" : "0") + '"/>  </c:ext></c:extLst></c:dLbls>') + '<c:axId val="'.concat(t, '"/><c:axId val="').concat(e, '"/>') + "</c:bubbleChart>";
            break;
        case v.DOUGHNUT:
            case v.PIE:
            a = o[0],
            c = (c = (c = (c = (c = (c = (c = (c = (c = c + ("<c:" + A + "Chart>") + '  <c:varyColors val="1"/>') + "<c:ser>" + '  <c:idx val="0"/>') + '  <c:order val="0"/>' + "  <c:tx>") + "    <c:strRef>" + "      <c:f>Sheet1!$B$1</c:f>") + "      <c:strCache>" + '        <c:ptCount val="1"/>') + ('        <c:pt idx="0"><c:v>' + I(a.name) + "</c:v></c:pt>")) + "      </c:strCache>" + "    </c:strRef>") + "  </c:tx>" + "  <c:spPr>") + '    <a:solidFill><a:schemeClr val="accent1"/></a:solidFill>' + '    <a:ln w="9525" cap="flat"><a:solidFill><a:srgbClr val="F9F9F9"/></a:solidFill><a:prstDash val="solid"/><a:round/></a:ln>',
            n.dataNoEffects ? c += "<a:effectLst/>": c += b(n.shadow, s),
            c += "  </c:spPr>",
            a.labels[0].forEach(function(e, t) {
                c = (c = (c += "<c:dPt>") + ' <c:idx val="'.concat(t, '"/>') + ' <c:bubble3D val="0"/> <c:spPr>') + "<a:solidFill>".concat(z(n.chartColors[t + 1 > n.chartColors.length ? Math.floor(Math.random() * n.chartColors.length) : t]), "</a:solidFill>"),
                n.dataBorder && (c += '<a:ln w="'.concat(O(n.dataBorder.pt), '" cap="flat"><a:solidFill>').concat(z(n.dataBorder.color), '</a:solidFill><a:prstDash val="solid"/><a:round/></a:ln>')),
                c = c + b(n.shadow, s) + "  </c:spPr></c:dPt>"
            }),
            c += "<c:dLbls>",
            a.labels[0].forEach(function(e, t) {
                c = (c = (c = (c = (c = (c += "<c:dLbl>") + ' <c:idx val="'.concat(t, '"/>')) + '  <c:numFmt formatCode="'.concat(I(n.dataLabelFormatCode) || "General", '" sourceLinked="0"/>') + "  <c:spPr/><c:txPr>   <a:bodyPr/><a:lstStyle/>   <a:p><a:pPr>") + '   <a:defRPr sz="'.concat(Math.round(100 * (n.dataLabelFontSize || P)), '" b="').concat(n.dataLabelFontBold ? 1 : 0, '" i="').concat(n.dataLabelFontItalic ? 1 : 0, '" u="none" strike="noStrike">')) + "    <a:solidFill>" + z(n.dataLabelColor || w) + "</a:solidFill>") + '    <a:latin typeface="'.concat(n.dataLabelFontFace || "Arial", '"/>') + "   </a:defRPr>      </a:pPr></a:p>    </c:txPr>",
                A === v.PIE && n.dataLabelPosition && (c += '<c:dLblPos val="'.concat(n.dataLabelPosition, '"/>')),
                c = (c = (c = (c = (c += '    <c:showLegendKey val="0"/>') + '    <c:showVal val="' + (n.showValue ? "1" : "0") + '"/>') + '    <c:showCatName val="' + (n.showLabel ? "1" : "0") + '"/>') + '    <c:showSerName val="' + (n.showSerName ? "1" : "0") + '"/>') + '    <c:showPercent val="' + (n.showPercent ? "1" : "0") + '"/>    <c:showBubbleSize val="0"/>  </c:dLbl>'
            }),
            c = (c = (c = (c = (c = (c = (c = (c = (c = (c = (c = (c = (c = (c = c + ' <c:numFmt formatCode="'.concat(I(n.dataLabelFormatCode) || "General", '" sourceLinked="0"/>') + "    <c:txPr>") + "      <a:bodyPr/>" + "      <a:lstStyle/>") + "      <a:p>" + "        <a:pPr>") + '          <a:defRPr sz="1800" b="'.concat(n.dataLabelFontBold ? "1" : "0", '" i="').concat(n.dataLabelFontItalic ? "1" : "0", '" u="none" strike="noStrike">') + '            <a:solidFill><a:srgbClr val="000000"/></a:solidFill><a:latin typeface="Arial"/>') + "          </a:defRPr>" + "        </a:pPr>") + "      </a:p>" + "    </c:txPr>") + (A === v.PIE ? '<c:dLblPos val="ctr"/>': "")) + '    <c:showLegendKey val="0"/>' + '    <c:showVal val="0"/>') + '    <c:showCatName val="1"/>' + '    <c:showSerName val="0"/>') + '    <c:showPercent val="1"/>' + '    <c:showBubbleSize val="0"/>') + ' <c:showLeaderLines val="'.concat(n.showLeaderLines ? "1" : "0", '"/>') + "</c:dLbls>") + "<c:cat>" + "  <c:strRef>") + "    <c:f>Sheet1!$A$2:$A$".concat(a.labels[0].length + 1, "</c:f>") + "    <c:strCache>") + '         <c:ptCount val="'.concat(a.labels[0].length, '"/>'),
            a.labels[0].forEach(function(e, t) {
                c += '<c:pt idx="'.concat(t, '"><c:v>').concat(I(e), "</c:v></c:pt>")
            }),
            c = (c = (c = (c = (c += "    </c:strCache>") + "  </c:strRef>" + "</c:cat>") + "  <c:val>" + "    <c:numRef>") + "      <c:f>Sheet1!$B$2:$B$".concat(a.labels[0].length + 1, "</c:f>") + "      <c:numCache>") + '           <c:ptCount val="'.concat(a.labels[0].length, '"/>'),
            a.values.forEach(function(e, t) {
                c += '<c:pt idx="'.concat(t, '"><c:v>').concat(e || 0 === e ? e : "", "</c:v></c:pt>")
            }),
            c = (c = (c = c + "      </c:numCache>" + "    </c:numRef>") + "  </c:val>" + "  </c:ser>") + '  <c:firstSliceAng val="'.concat(n.firstSliceAng ? Math.round(n.firstSliceAng) : 0, '"/>'),
            A === v.DOUGHNUT && (c += '<c:holeSize val="'.concat("number" == typeof n.holeSize ? n.holeSize : "50", '"/>')),
            c += "</c:" + A + "Chart>";
            break;
        default:
            c += ""
    ...
    function Se(t, e, a) {
        var A = "";
        return t._type === v.SCATTER || t._type === v.BUBBLE || t._type === v.BUBBLE3D ? A += "<c:valAx>": A += "<c:" + (t.catLabelFormatCode ? "dateAx" : "catAx") + ">",
        A = (A += '  <c:axId val="' + e + '"/>') + "  <c:scaling>" + ('<c:orientation val="' + (t.catAxisOrientation || (t.barDir, "minMax")) + '"/>'),
        !t.catAxisMaxVal && 0 !== t.catAxisMaxVal || (A += '<c:max val="'.concat(t.catAxisMaxVal, '"/>')),
        !t.catAxisMinVal && 0 !== t.catAxisMinVal || (A += '<c:min val="'.concat(t.catAxisMinVal, '"/>')),
        A = (A = (A = A + "</c:scaling>" + ('  <c:delete val="' + (t.catAxisHidden ? "1" : "0") + '"/>')) + ('  <c:axPos val="' + ("col" === t.barDir ? "b" : "l") + '"/>')) + ("none" !== t.catGridLine.style ? Fe(t.catGridLine) : ""),
        t.showCatAxisTitle && (A += Ne({
        ...
        t._type === v.SCATTER || t._type === v.BUBBLE || t._type === v.BUBBLE3D ? A += '  <c:numFmt formatCode="' + (t.valAxisLabelFormatCode ? I(t.valAxisLabelFormatCode) : "General") + '" sourceLinked="1"/>': A += '  <c:numFmt formatCode="' + (I(t.catLabelFormatCode) || "General") + '" sourceLinked="1"/>',
        t._type === v.SCATTER ? A += '  <c:majorTickMark val="none"/>  <c:minorTickMark val="none"/>  <c:tickLblPos val="nextTo"/>': A = (A = (A += '  <c:majorTickMark val="' + (t.catAxisMajorTickMark || "out") + '"/>') + '  <c:minorTickMark val="' + (t.catAxisMinorTickMark || "none") + '"/>') + '  <c:tickLblPos val="' + (t.catAxisLabelPos || ("col" === t.barDir ? "low" : "nextTo")) + '"/>',
        A = (A = (A = (A = (A = (A += "  <c:spPr>") + '    <a:ln w="'.concat(t.catAxisLineSize ? O(t.catAxisLineSize) : x, '" cap="flat">')) + (t.catAxisLineShow ? "<a:solidFill>" + z(t.catAxisLineColor || C.color) + "</a:solidFill>": "<a:noFill/>")) + ('      <a:prstDash val="' + (t.catAxisLineStyle || "solid") + '"/>')) + "      <a:round/>" + "    </a:ln>") + "  </c:spPr>" + "  <c:txPr>",
        t.catAxisLabelRotate ? A += '<a:bodyPr rot="'.concat(k(t.catAxisLabelRotate), '"/>') : A += "<a:bodyPr/>",
        A = (A = (A = (A = (A = (A = (A = (A = (A = (A = (A += "    <a:lstStyle/>") + "    <a:p>" + "    <a:pPr>") + '      <a:defRPr sz="'.concat(Math.round(100 * (t.catAxisLabelFontSize || P)), '" b="').concat(t.catAxisLabelFontBold ? 1 : 0, '" i="').concat(t.catAxisLabelFontItalic ? 1 : 0, '" u="none" strike="noStrike">')) + ("      <a:solidFill>" + z(t.catAxisLabelColor || w) + "</a:solidFill>")) + ('      <a:latin typeface="' + (t.catAxisLabelFontFace || "Arial") + '"/>')) + "   </a:defRPr>" + "  </a:pPr>") + ('  <a:endParaRPr lang="' + (t.lang || "en-US") + '"/>') + "  </a:p>") + " </c:txPr>" + (' <c:crossAx val="' + a + '"/>')) + " <c:".concat("number" == typeof t.valAxisCrossesAt ? "crossesAt" : "crosses", ' val="').concat(t.valAxisCrossesAt || "autoZero", '"/>')) + ' <c:auto val="1"/>' + ' <c:lblAlgn val="ctr"/>') + ' <c:noMultiLvlLbl val="'.concat(t.catAxisMultiLevelLabels ? 0 : 1, '"/>'),
        t.catAxisLabelFrequency && (A += ' <c:tickLblSkip val="' + t.catAxisLabelFrequency + '"/>'),
        (t.catLabelFormatCode || t._type === v.SCATTER || t._type === v.BUBBLE || t._type === v.BUBBLE3D) && (t.catLabelFormatCode && (["catAxisBaseTimeUnit", "catAxisMajorTimeUnit", "catAxisMinorTimeUnit"].forEach(function(e) { ! t[e] || "string" == typeof t[e] && ["days", "months", "years"].includes(t[e].toLowerCase()) || (console.warn('"'.concat(e, "\" must be one of: 'days','months','years' !")), t[e] = null)
        }), t.catAxisBaseTimeUnit && (A += '<c:baseTimeUnit val="' + t.catAxisBaseTimeUnit.toLowerCase() + '"/>'), t.catAxisMajorTimeUnit && (A += '<c:majorTimeUnit val="' + t.catAxisMajorTimeUnit.toLowerCase() + '"/>'), t.catAxisMinorTimeUnit) && (A += '<c:minorTimeUnit val="' + t.catAxisMinorTimeUnit.toLowerCase() + '"/>'), t.catAxisMajorUnit && (A += '<c:majorUnit val="'.concat(t.catAxisMajorUnit, '"/>')), t.catAxisMinorUnit) && (A += '<c:minorUnit val="'.concat(t.catAxisMinorUnit, '"/>')),
        t._type === v.SCATTER || t._type === v.BUBBLE || t._type === v.BUBBLE3D ? A += "</c:valAx>": A += "</c:" + (t.catLabelFormatCode ? "dateAx" : "catAx") + ">",
        A
    }
    function Ee(e, t) {
        var a = t === L ? "col" === e.barDir ? "l" : "b" : "col" !== e.barDir ? "r" : "t",
        A = (t === le && (a = "r"), t === L ? ce : ie),
        o = "",
        o = (o += "<c:valAx>") + ('  <c:axId val="' + t + '"/>') + "  <c:scaling>";
        return e.valAxisLogScaleBase && (o += '<c:logBase val="'.concat(e.valAxisLogScaleBase, '"/>')),
        o += '<c:orientation val="' + (e.valAxisOrientation || (e.barDir, "minMax")) + '"/>',
        !e.valAxisMaxVal && 0 !== e.valAxisMaxVal || (o += '<c:max val="'.concat(e.valAxisMaxVal, '"/>')),
        !e.valAxisMinVal && 0 !== e.valAxisMinVal || (o += '<c:min val="'.concat(e.valAxisMinVal, '"/>')),
        o = (o += "  </c:scaling>") + '  <c:delete val="'.concat(e.valAxisHidden ? 1 : 0, '"/>') + ('  <c:axPos val="' + a + '"/>'),
        "none" !== e.valGridLine.style && (o += Fe(e.valGridLine)),
        e.showValAxisTitle && (o += Ne({
        ...
        o += '<c:numFmt formatCode="'.concat(e.valAxisLabelFormatCode ? I(e.valAxisLabelFormatCode) : "General", '" sourceLinked="0"/>'),
        e._type === v.SCATTER ? o += '  <c:majorTickMark val="none"/>  <c:minorTickMark val="none"/>  <c:tickLblPos val="nextTo"/>': o = (o = (o += ' <c:majorTickMark val="' + (e.valAxisMajorTickMark || "out") + '"/>') + ' <c:minorTickMark val="' + (e.valAxisMinorTickMark || "none") + '"/>') + ' <c:tickLblPos val="' + (e.valAxisLabelPos || ("col" === e.barDir ? "nextTo" : "low")) + '"/>',
        o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o += " <c:spPr>") + '   <a:ln w="'.concat(e.valAxisLineSize ? O(e.valAxisLineSize) : x, '" cap="flat">')) + (e.valAxisLineShow ? "<a:solidFill>" + z(e.valAxisLineColor || C.color) + "</a:solidFill>": "<a:noFill/>")) + ('     <a:prstDash val="' + (e.valAxisLineStyle || "solid") + '"/>')) + "     <a:round/>" + "   </a:ln>") + " </c:spPr>" + " <c:txPr>") + "  <a:bodyPr".concat(e.valAxisLabelRotate ? ' rot="' + k(e.valAxisLabelRotate).toString() + '"' : "", "/>") + "  <a:lstStyle/>") + "  <a:p>" + "    <a:pPr>") + '      <a:defRPr sz="'.concat(Math.round(100 * (e.valAxisLabelFontSize || P)), '" b="').concat(e.valAxisLabelFontBold ? 1 : 0, '" i="').concat(e.valAxisLabelFontItalic ? 1 : 0, '" u="none" strike="noStrike">')) + ("        <a:solidFill>" + z(e.valAxisLabelColor || w) + "</a:solidFill>")) + ('        <a:latin typeface="' + (e.valAxisLabelFontFace || "Arial") + '"/>')) + "      </a:defRPr>" + "    </a:pPr>") + ('  <a:endParaRPr lang="' + (e.lang || "en-US") + '"/>') + "  </a:p>") + " </c:txPr>" + (' <c:crossAx val="' + A + '"/>'),
        "number" == typeof e.catAxisCrossesAt ? o += ' <c:crossesAt val="'.concat(e.catAxisCrossesAt, '"/>') : "string" == typeof e.catAxisCrossesAt ? o += ' <c:crosses val="' + e.catAxisCrossesAt + '"/>': o += ' <c:crosses val="' + ("r" === a || "t" === a ? "max" : "autoZero") + '"/>',
        o += ' <c:crossBetween val="' + (e._type === v.SCATTER || Array.isArray(e._type) && 0 < e._type.filter(function(e) {
            return e.type === v.AREA
        }).length ? "midCat" : "between") + '"/>',
        e.valAxisMajorUnit && (o += ' <c:majorUnit val="'.concat(e.valAxisMajorUnit, '"/>')),
        e.valAxisDisplayUnit && (o += '<c:dispUnits><c:builtInUnit val="'.concat(e.valAxisDisplayUnit, '"/>').concat(e.valAxisDisplayUnitLabel ? "<c:dispUnitsLbl/>": "", "</c:dispUnits>")),
        o += "</c:valAx>"
    }
    function Ne(e, t, a) {
        var A = "left" === e.titleAlign || "right" === e.titleAlign ? '<a:pPr algn="'.concat(e.titleAlign.substring(0, 1), '">') : "<a:pPr>",
        o = e.titleRotate ? '<a:bodyPr rot="'.concat(k(e.titleRotate), '"/>') : "<a:bodyPr/>",
        n = e.fontSize ? 'sz="'.concat(Math.round(100 * e.fontSize), '"') : "",
        r = e.titleBold ? 1 : 0,
        l = "<c:layout/>";
        return e.titlePos && "number" == typeof e.titlePos.x && "number" == typeof e.titlePos.y && (1 <= (t = 0 === (t = e.titlePos.x + t) ? 0 : t * (t / 5) / 10) && (t /= 10), .1 <= t && (t /= 10), 1 <= (a = 0 === (a = e.titlePos.y + a) ? 0 : a * (a / 5) / 10) && (a /= 10), .1 <= a && (a /= 10), l = '<c:layout><c:manualLayout><c:xMode val="edge"/><c:yMode val="edge"/><c:x val="'.concat(t, '"/><c:y val="').concat(a, '"/></c:manualLayout></c:layout>')),
    ...
    function B(e) {
        e -= 1;
        return e <= 25 ? pe[e] : "".concat(pe[Math.floor(e / pe.length - 1)]).concat(pe[e % pe.length])
    }
    function b(e, t) {
        var a, A, o, n, r, l;
        return e ? "object" != typeof e ? (console.warn("`shadow` options must be an object. Ex: `{shadow: {type:'none'}}`"), "<a:effectLst/>") : (a = "<a:effectLst>", e = (t = y(y({},
        t), e)).type || "outer", A = O(t.blur), o = O(t.offset), n = Math.round(6e4 * t.angle), r = t.color, l = Math.round(1e5 * t.opacity), t = t.rotateWithShape ? 1 : 0, (a = (a = (a += "<a:".concat(e, 'Shdw sx="100000" sy="100000" kx="0" ky="0"  algn="bl" blurRad="').concat(A, '" rotWithShape="').concat(t, '" dist="').concat(o, '" dir="').concat(n, '">')) + '<a:srgbClr val="'.concat(r, '">')) + '<a:alpha val="'.concat(l, '"/></a:srgbClr>')) + "</a:".concat(e, "Shdw>") + "</a:effectLst>") : "<a:effectLst/>"
    }
    function Fe(e) {
        var t = "<c:majorGridlines>";
        return (t += " <c:spPr>") + '  <a:ln w="'.concat(O(e.size || C.size), '" cap="').concat(Re(e.cap || C.cap), '">') + ('  <a:solidFill><a:srgbClr val="' + (e.color || C.color) + '"/></a:solidFill>') + ('   <a:prstDash val="' + (e.style || C.style) + '"/><a:round/>') + "  </a:ln>" + " </c:spPr>" + "</c:majorGridlines>"
    }
    function Re(e) {
        if (e && "flat" !== e) {
    ...
    function Ie(e) {
        var n = "undefined" != typeof require && "undefined" == typeof window ? require("fs") : null,
        r = "undefined" != typeof require && "undefined" == typeof window ? require("https") : null,
        t = [],
        ...
        l.filter(function(e) {
            ...
            t.push(new Promise(function(a, A) {
                var t;
                if (n && 0 !== o.path.indexOf("http")) try {
                    ...
                    A(new Error('ERROR: Unable to read media: "'.concat(o.path, '"\n').concat(String(e))))
                } else n && r && 0 === o.path.indexOf("http") ? r.get(o.path, function(e) {
                    var t = "";
                    ...
                    e.on("end", function() {
                        o.data = Buffer.from(t, "binary").toString("base64"),
                        l.filter(function(e) {
                            return e.isDuplicate && e.path === o.path
                        }).forEach(function(e) {
                            return e.data = o.data
                    ...
                    e.on("error", function(e) {
                        ...
                        A(new Error("ERROR! Unable to load image (https.get): ".concat(o.path)))
                    })
                ...
                t.onerror = function(e) {
                    ...
                    A(new Error("ERROR! Unable to load image (xhr.onerror): ".concat(o.path)))
                },
                t.open("GET", o.path), t.responseType = "blob", t.send())
            }))
        }),
        e._relsMedia.filter(function(e) {
            return e.isSvgPng && e.data
        }).forEach(function(e) {
            n ? (e.data = h, t.push(Promise.resolve().then(function() {
                return "done"
            }))) : t.push(Me(e))
        }),
        t
                ...
                case 0:
                    return [4, new Promise(function(a, t) {
                        ...
                        A.onerror = function(e) {
                            o.data = h,
                            t(new Error("ERROR! Unable to load image (image.onerror): ".concat(o.path)))
                        },
    ...
    var Oe = {
        cover: function(e, t) {
            ...
            return '<a:srcRect l="'.concat(e, '" r="').concat(e, '" t="').concat(A, '" b="').concat(A, '"/><a:stretch/>')
        },
        ...
        crop: function(e, t) {
            ...
            return '<a:srcRect l="'.concat(a, '" r="').concat(A, '" t="').concat(o, '" b="').concat(t, '"/><a:stretch/>')
        }
    };
    function ke(D) {
        var e, S = D._name ? '<p:cSld name="' + D._name + '">': "<p:cSld>",
        E = 1;
        return D._bkgdImgRid ? S += '<p:bg><p:bgPr><a:blipFill dpi="0" rotWithShape="1"><a:blip r:embed="rId'.concat(D._bkgdImgRid, '"><a:lum/></a:blip><a:srcRect/><a:stretch><a:fillRect/></a:stretch></a:blipFill><a:effectLst/></p:bgPr></p:bg>') : null != (e = D.background) && e.color ? S += "<p:bg><p:bgPr>".concat(U(D.background), "</p:bgPr></p:bg>") : !D.bkgd && D._name && D._name === ae && (S += '<p:bg><p:bgRef idx="1001"><a:schemeClr val="bg1"/></p:bgRef></p:bg>'),
        S = (S = S + "<p:spTree>" + '<p:nvGrpSpPr><p:cNvPr id="1" name=""/><p:cNvGrpSpPr/><p:nvPr/></p:nvGrpSpPr>') + '<p:grpSpPr><a:xfrm><a:off x="0" y="0"/><a:ext cx="0" cy="0"/>' + '<a:chOff x="0" y="0"/><a:chExt cx="0" cy="0"/></a:xfrm></p:grpSpPr>',
        D._slideObjects.forEach(function(A, e) {
            var t, a, i, o, n, r, l, c, s = 0,
            p = 0,
            ...
            x = (void 0 !== D._slideLayout && void 0 !== D._slideLayout._slideObjects && A.options && A.options.placeholder && (a = D._slideLayout._slideObjects.filter(function(e) {
                return e.options.placeholder === A.options.placeholder
            })[0]), A.options = A.options || {},
            void 0 !== A.options.x && (s = R(A.options.x, "X", D._presLayout)), void 0 !== A.options.y && (p = R(A.options.y, "Y", D._presLayout)), d = void 0 !== A.options.w ? R(A.options.w, "X", D._presLayout) : d),
            C = f = void 0 !== A.options.h ? R(A.options.h, "Y", D._presLayout) : f;
            switch (a && (!a.options.x && 0 !== a.options.x || (s = R(a.options.x, "X", D._presLayout)), !a.options.y && 0 !== a.options.y || (p = R(a.options.y, "Y", D._presLayout)), !a.options.w && 0 !== a.options.w || (d = R(a.options.w, "X", D._presLayout)), !a.options.h && 0 !== a.options.h || (f = R(a.options.h, "Y", D._presLayout))), A.options.flipH && (u += ' flipH="1"'), A.options.flipV && (u += ' flipV="1"'), A.options.rotate && (u += ' rot="'.concat(k(A.options.rotate), '"')), A._type) {
            case N.table:
                if (h = A.arrTabRows, i = A.options, h[m = g = 0].forEach(function(e) {
                    o = e.options || null,
                    g += null !== o && o.colspan ? Number(o.colspan) : 1
                }), b = '<p:graphicFrame><p:nvGraphicFramePr><p:cNvPr id="'.concat(E * D._slideNum + 1, '" name="').concat(A.options.objectName, '"/>'), b = (b += '<p:cNvGraphicFramePr><a:graphicFrameLocks noGrp="1"/></p:cNvGraphicFramePr>  <p:nvPr><p:extLst><p:ext uri="{D42A27DB-BD31-4B8C-83A1-F6EECF244321}"><p14:modId xmlns:p14="http://schemas.microsoft.com/office/powerpoint/2010/main" val="1579011935"/></p:ext></p:extLst></p:nvPr></p:nvGraphicFramePr>') + '<p:xfrm><a:off x="'.concat(s || (0 === s ? 0 : F), '" y="').concat(p || (0 === p ? 0 : F), '"/><a:ext cx="').concat(d || (0 === d ? 0 : F), '" cy="').concat(f || F, '"/></p:xfrm>') + '<a:graphic><a:graphicData uri="http://schemas.openxmlformats.org/drawingml/2006/table"><a:tbl><a:tblPr/>', Array.isArray(i.colW)) {
                    b += "<a:tblGrid>";
                    for (var w = 0; w < g; w++) {
                        var P = M(i.colW[w]);
                        null != P && !isNaN(P) || (P = ("number" == typeof A.options.w ? A.options.w : 1) / g),
                        b += '<a:gridCol w="'.concat(Math.round(P), '"/>')
                    }
                } else {
                    m = i.colW || F,
                    A.options.w && !i.colW && (m = Math.round(("number" == typeof A.options.w ? A.options.w : 1) / g)),
                    b += "<a:tblGrid>";
                    for (var L = 0; L < g; L++) b += '<a:gridCol w="'.concat(m, '"/>')
                }
                b += "</a:tblGrid>",
                h.forEach(function(o) {
                    for (var n, r, e = 0; e < o.length;) ! function(e) {
                        var t = o[e],
                        a = null == (n = t.options) ? void 0 : n.colspan,
                        A = null == (n = t.options) ? void 0 : n.rowspan;
                        a && 1 < a ? (t = new Array(a - 1).fill(void 0).map(function(e) {
                            return {
                                _type: N.tablecell,
                                options: {
                                    rowspan: A
                        ...
                        }), o.splice.apply(o, Q([e + 1, 0], t, !1)), e += a) : e += 1,
                        r = e
                    } (e),
                    e = r
                }),
                h.forEach(function(e, t) {
                    ...
                    o && e.forEach(function(e, t) {
                        var a = e._rowContinue || (null == (a = e.options) ? void 0 : a.rowspan),
                ...
                h.forEach(function(e, t) {
                    var a = 0;
                    Array.isArray(i.rowH) && i.rowH[t] ? a = M(Number(i.rowH[t])) : i.rowH && !isNaN(Number(i.rowH)) ? a = M(Number(i.rowH)) : (A.options.cy || A.options.h) && (a = Math.round((A.options.h ? M(A.options.h) : "number" == typeof A.options.cy ? A.options.cy : 1) / h.length)),
                    b += '<a:tr h="'.concat(a, '">'),
                    e.forEach(function(e) {
                        var t, a, A, o, n, r, l = {
                            rowSpan: 1 < (null == (c = e.options) ? void 0 : c.rowspan) ? e.options.rowspan : void 0,
                            gridSpan: 1 < (null == (c = e.options) ? void 0 : c.colspan) ? e.options.colspan : void 0,
                            vMerge: e._vmerge ? 1 : void 0,
                            hMerge: e._hmerge ? 1 : void 0
                        },
                        c = (c = Object.keys(l).map(function(e) {
                            return [e, l[e]]
                        }).filter(function(e) {
                            return e[0],
                            !!e[1]
            ...
            case N.text:
                ...
                null != (n = A.options.points) && n.forEach(function(e, t) {
                    ...
                    case "quadratic":
                        S += '<a:quadBezTo>\n\t\t\t\t\t\t\t\t\t<a:pt x="'.concat(R(e.curve.x1, "X", D._presLayout), '" y="').concat(R(e.curve.y1, "Y", D._presLayout), '" />\n\t\t\t\t\t\t\t\t\t<a:pt x="').concat(R(e.x, "X", D._presLayout), '" y="').concat(R(e.y, "Y", D._presLayout), '" />\n\t\t\t\t\t\t\t\t\t</a:quadBezTo>')
                    } else "close" in  e ? S += "<a:close />": e.moveTo || 0 === t ? S += '<a:moveTo><a:pt x="'.concat(R(e.x, "X", D._presLayout), '" y="').concat(R(e.y, "Y", D._presLayout), '" /></a:moveTo>') : S += '<a:lnTo><a:pt x="'.concat(R(e.x, "X", D._presLayout), '" y="').concat(R(e.y, "Y", D._presLayout), '" /></a:lnTo>')
                }),
                S += "</a:path></a:pathLst></a:custGeom>";
                else {
                    if (S += '<a:prstGeom prst="' + A.shape + '"><a:avLst>', A.options.rectRadius) S += '<a:gd name="adj" fmla="val '.concat(Math.round(A.options.rectRadius * F * 1e5 / Math.min(d, f)), '"/>');
                    else
                    if (A.options.angleRange) {
                        for (var B = 0; B < 2; B++) {
                            var T = A.options.angleRange[B];
                            S += '<a:gd name="adj'.concat(B + 1, '" fmla="val ').concat(k(T), '" />')
                        }
                        A.options.arcThicknessRatio && (S += '<a:gd name="adj3" fmla="val '.concat(Math.round(5e4 * A.options.arcThicknessRatio), '" />'))
                    }
                    S += "</a:avLst></a:prstGeom>"
                }
                S += A.options.fill ? U(A.options.fill) : "<a:noFill/>",
                A.options.line && (S += A.options.line.width ? '<a:ln w="'.concat(O(A.options.line.width), '">') : "<a:ln>", A.options.line.color && (S += U(A.options.line)), A.options.line.dashType && (S += '<a:prstDash val="'.concat(A.options.line.dashType, '"/>')), A.options.line.beginArrowType && (S += '<a:headEnd type="'.concat(A.options.line.beginArrowType, '"/>')), A.options.line.endArrowType && (S += '<a:tailEnd type="'.concat(A.options.line.endArrowType, '"/>')), S += "</a:ln>"),
                A.options.shadow && "none" !== A.options.shadow.type && (A.options.shadow.type = A.options.shadow.type || "outer", A.options.shadow.blur = O(A.options.shadow.blur || 8), A.options.shadow.offset = O(A.options.shadow.offset || 4), A.options.shadow.angle = Math.round(6e4 * (A.options.shadow.angle || 270)), A.options.shadow.opacity = Math.round(1e5 * (A.options.shadow.opacity || .75)), A.options.shadow.color = A.options.shadow.color || ne.color, S = (S = (S = (S += "<a:effectLst>") + " <a:".concat(A.options.shadow.type, "Shdw ").concat("outer" === A.options.shadow.type ? 'sx="100000" sy="100000" kx="0" ky="0" algn="bl" rotWithShape="0"' : "", ' blurRad="').concat(A.options.shadow.blur, '" dist="').concat(A.options.shadow.offset, '" dir="').concat(A.options.shadow.angle, '">')) + ' <a:srgbClr val="'.concat(A.options.shadow.color, '">')) + ' <a:alpha val="'.concat(A.options.shadow.opacity, '"/></a:srgbClr>') + " </a:outerShdw></a:effectLst>"),
                S = (S += "</p:spPr>") + Ge(A) + "</p:sp>";
                break;
            case N.image:
                S = (S = S + "<p:pic>" + "  <p:nvPicPr>") + '<p:cNvPr id="'.concat(e + 2, '" name="').concat(A.options.objectName, '" descr="').concat(I(A.options.altText || A.image), '">'),
                null != (n = A.hyperlink) && n.url && (S += '<a:hlinkClick r:id="rId'.concat(A.hyperlink._rId, '" tooltip="').concat(A.hyperlink.tooltip ? I(A.hyperlink.tooltip) : "", '"/>')),
                null != (n = A.hyperlink) && n.slide && (S += '<a:hlinkClick r:id="rId'.concat(A.hyperlink._rId, '" tooltip="').concat(A.hyperlink.tooltip ? I(A.hyperlink.tooltip) : "", '" action="ppaction://hlinksldjump"/>')),
                S = (S = (S = S + "    </p:cNvPr>" + '    <p:cNvPicPr><a:picLocks noChangeAspect="1"/></p:cNvPicPr>') + ("    <p:nvPr>" + je(a) + "</p:nvPr>")) + "  </p:nvPicPr>" + "<p:blipFill>",
                S = (D._relsMedia || []).filter(function(e) {
                    return e.rId === A.imageRid
                })[0] && "svg" === (D._relsMedia || []).filter(function(e) {
                    return e.rId === A.imageRid
                })[0].extn ? (S = (S += '<a:blip r:embed="rId'.concat(A.imageRid - 1, '">')) + (A.options.transparency ? ' <a:alphaModFix amt="'.concat(Math.round(1e3 * (100 - A.options.transparency)), '"/>') : "") + ' <a:extLst>  <a:ext uri="{96DAC541-7B7A-43D3-8B79-37D633B846F1}">') + '   <asvg:svgBlip xmlns:asvg="http://schemas.microsoft.com/office/drawing/2016/SVG/main" r:embed="rId'.concat(A.imageRid, '"/>') + "  </a:ext> </a:extLst></a:blip>": (S += '<a:blip r:embed="rId'.concat(A.imageRid, '">')) + (A.options.transparency ? '<a:alphaModFix amt="'.concat(Math.round(1e3 * (100 - A.options.transparency)), '"/>') : "") + "</a:blip>",
                null != y && y.type ? (n = y.w ? R(y.w, "X", D._presLayout) : d, r = y.h ? R(y.h, "Y", D._presLayout) : f, l = R(y.x || 0, "X", D._presLayout), c = R(y.y || 0, "Y", D._presLayout), S += Oe[y.type]({
                    w: x,
                    h: C
                },
                {
                    ...
                    x: l,
                    y: c
                }), x = n, C = r) : S += "  <a:stretch><a:fillRect/></a:stretch>",
                S = (S = (S = (S = (S += "</p:blipFill>") + "<p:spPr>" + (" <a:xfrm" + u + ">")) + '  <a:off x="'.concat(s, '" y="').concat(p, '"/>')) + '  <a:ext cx="'.concat(x, '" cy="').concat(C, '"/>') + " </a:xfrm>") + ' <a:prstGeom prst="'.concat(v ? "ellipse" : "rect", '"><a:avLst/></a:prstGeom>'),
                A.options.shadow && "none" !== A.options.shadow.type && (A.options.shadow.type = A.options.shadow.type || "outer", A.options.shadow.blur = O(A.options.shadow.blur || 8), A.options.shadow.offset = O(A.options.shadow.offset || 4), A.options.shadow.angle = Math.round(6e4 * (A.options.shadow.angle || 270)), A.options.shadow.opacity = Math.round(1e5 * (A.options.shadow.opacity || .75)), A.options.shadow.color = A.options.shadow.color || ne.color, S = (S = (S = (S = (S += "<a:effectLst>") + "<a:".concat(A.options.shadow.type, "Shdw ").concat("outer" === A.options.shadow.type ? 'sx="100000" sy="100000" kx="0" ky="0" algn="bl" rotWithShape="0"' : "", ' blurRad="').concat(A.options.shadow.blur, '" dist="').concat(A.options.shadow.offset, '" dir="').concat(A.options.shadow.angle, '">')) + '<a:srgbClr val="'.concat(A.options.shadow.color, '">')) + '<a:alpha val="'.concat(A.options.shadow.opacity, '"/></a:srgbClr>')) + "</a:".concat(A.options.shadow.type, "Shdw>") + "</a:effectLst>"),
                S = S + "</p:spPr>" + "</p:pic>";
                break;
            case N.media:
                S = "online" === A.mtype ? (S = (S = (S = (S += "<p:pic> <p:nvPicPr>") + '<p:cNvPr id="'.concat(A.mediaRid + 2, '" name="').concat(A.options.objectName, '"/>') + " <p:cNvPicPr/> <p:nvPr>") + '  <a:videoFile r:link="rId'.concat(A.mediaRid, '"/>') + " </p:nvPr> </p:nvPicPr>") + ' <p:blipFill><a:blip r:embed="rId'.concat(A.mediaRid + 1, '"/><a:stretch><a:fillRect/></a:stretch></p:blipFill>') + " <p:spPr>") + "  <a:xfrm".concat(u, '><a:off x="').concat(s, '" y="').concat(p, '"/><a:ext cx="').concat(d, '" cy="').concat(f, '"/></a:xfrm>') + '  <a:prstGeom prst="rect"><a:avLst/></a:prstGeom> </p:spPr></p:pic>': (S = (S = (S = (S = (S += "<p:pic> <p:nvPicPr>") + '<p:cNvPr id="'.concat(A.mediaRid + 2, '" name="').concat(A.options.objectName, '"><a:hlinkClick r:id="" action="ppaction://media"/></p:cNvPr>') + ' <p:cNvPicPr><a:picLocks noChangeAspect="1"/></p:cNvPicPr> <p:nvPr>') + '  <a:videoFile r:link="rId'.concat(A.mediaRid, '"/>') + '  <p:extLst>   <p:ext uri="{DAA4B4D4-6D71-4841-9C94-3DE7FCFB9230}">') + '    <p14:media xmlns:p14="http://schemas.microsoft.com/office/powerpoint/2010/main" r:embed="rId'.concat(A.mediaRid + 1, '"/>') + "   </p:ext>  </p:extLst> </p:nvPr> </p:nvPicPr>") + ' <p:blipFill><a:blip r:embed="rId'.concat(A.mediaRid + 2, '"/><a:stretch><a:fillRect/></a:stretch></p:blipFill>') + " <p:spPr>") + "  <a:xfrm".concat(u, '><a:off x="').concat(s, '" y="').concat(p, '"/><a:ext cx="').concat(d, '" cy="').concat(f, '"/></a:xfrm>') + '  <a:prstGeom prst="rect"><a:avLst/></a:prstGeom> </p:spPr></p:pic>';
                break;
            case N.chart:
                S = (S = (S = (S = (S = (S = (S = S + "<p:graphicFrame>" + " <p:nvGraphicFramePr>") + '   <p:cNvPr id="'.concat(e + 2, '" name="').concat(A.options.objectName, '" descr="').concat(I(A.options.altText || ""), '"/>') + "   <p:cNvGraphicFramePr/>") + "   <p:nvPr>".concat(je(a), "</p:nvPr>") + " </p:nvGraphicFramePr>") + ' <p:xfrm><a:off x="'.concat(s, '" y="').concat(p, '"/><a:ext cx="').concat(d, '" cy="').concat(f, '"/></p:xfrm>')) + ' <a:graphic xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main">' + '  <a:graphicData uri="http://schemas.openxmlformats.org/drawingml/2006/chart">') + '   <c:chart r:id="rId'.concat(A.chartRid, '" xmlns:c="http://schemas.openxmlformats.org/drawingml/2006/chart"/>') + "  </a:graphicData>") + " </a:graphic>" + "</p:graphicFrame>";
                break;
            default:
                S += ""
            }
        }),
        D._slideNumberProps && (D._slideNumberProps.align || (D._slideNumberProps.align = "left"), S = (S += '<p:sp> <p:nvSpPr>  <p:cNvPr id="25" name="Slide Number Placeholder 0"/><p:cNvSpPr><a:spLocks noGrp="1"/></p:cNvSpPr>  <p:nvPr><p:ph type="sldNum" sz="quarter" idx="4294967295"/></p:nvPr> </p:nvSpPr> <p:spPr>') + "<a:xfrm>" + '<a:off x="'.concat(R(D._slideNumberProps.x, "X", D._presLayout), '" y="').concat(R(D._slideNumberProps.y, "Y", D._presLayout), '"/>') + '<a:ext cx="'.concat(D._slideNumberProps.w ? R(D._slideNumberProps.w, "X", D._presLayout) : "800000", '" cy="').concat(D._slideNumberProps.h ? R(D._slideNumberProps.h, "Y", D._presLayout) : "300000", '"/>') + '</a:xfrm> <a:prstGeom prst="rect"><a:avLst/></a:prstGeom> <a:extLst><a:ext uri="{C572A759-6A51-4108-AA02-DFA0A04FC94B}"><ma14:wrappingTextBoxFlag val="0" xmlns:ma14="http://schemas.microsoft.com/office/mac/drawingml/2011/main"/></a:ext></a:extLst></p:spPr><p:txBody><a:bodyPr', D._slideNumberProps.margin && Array.isArray(D._slideNumberProps.margin) ? S = (S = (S = (S += ' lIns="'.concat(O(D._slideNumberProps.margin[3] || 0), '"')) + ' tIns="'.concat(O(D._slideNumberProps.margin[0] || 0), '"')) + ' rIns="'.concat(O(D._slideNumberProps.margin[1] || 0), '"')) + ' bIns="'.concat(O(D._slideNumberProps.margin[2] || 0), '"') : "number" == typeof D._slideNumberProps.margin && (S = (S = (S = (S += ' lIns="'.concat(O(D._slideNumberProps.margin || 0), '"')) + ' tIns="'.concat(O(D._slideNumberProps.margin || 0), '"')) + ' rIns="'.concat(O(D._slideNumberProps.margin || 0), '"')) + ' bIns="'.concat(O(D._slideNumberProps.margin || 0), '"')), D._slideNumberProps.valign && (S += ' anchor="'.concat(D._slideNumberProps.valign.replace("top", "t").replace("middle", "ctr").replace("bottom", "b"), '"')), S += "/>  <a:lstStyle><a:lvl1pPr>", (D._slideNumberProps.fontFace || D._slideNumberProps.fontSize || D._slideNumberProps.color) && (S += '<a:defRPr sz="'.concat(Math.round(100 * (D._slideNumberProps.fontSize || 12)), '">'), D._slideNumberProps.color && (S += U(D._slideNumberProps.color)), D._slideNumberProps.fontFace && (S += '<a:latin typeface="'.concat(D._slideNumberProps.fontFace, '"/><a:ea typeface="').concat(D._slideNumberProps.fontFace, '"/><a:cs typeface="').concat(D._slideNumberProps.fontFace, '"/>')), S += "</a:defRPr>"), S += "</a:lvl1pPr></a:lstStyle><a:p>", D._slideNumberProps.align.startsWith("l") ? S += '<a:pPr algn="l"/>': D._slideNumberProps.align.startsWith("c") ? S += '<a:pPr algn="ctr"/>': D._slideNumberProps.align.startsWith("r") ? S += '<a:pPr algn="r"/>': S += '<a:pPr algn="l"/>', S = (S += '<a:fld id="'.concat(ue, '" type="slidenum"><a:rPr b="').concat(D._slideNumberProps.bold ? 1 : 0, '" lang="en-US"/>')) + "<a:t>".concat(D._slideNum, '</a:t></a:fld><a:endParaRPr lang="en-US"/></a:p>') + "</p:txBody></p:sp>"),
        S = S + "</p:spTree>" + "</p:cSld>"
    }
    function ze(e, t) {
        var a = 0,
        A = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + u + '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">';
        return e._rels.forEach(function(e) {
            a = Math.max(a, e.rId),
            e.type.toLowerCase().includes("hyperlink") ? "slide" === e.data ? A += '<Relationship Id="rId'.concat(e.rId, '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide" Target="slide').concat(e.Target, '.xml"/>') : A += '<Relationship Id="rId'.concat(e.rId, '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink" Target="').concat(e.Target, '" TargetMode="External"/>') : e.type.toLowerCase().includes("notesSlide") && (A += '<Relationship Id="rId'.concat(e.rId, '" Target="').concat(e.Target, '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesSlide"/>'))
        }),
        (e._relsChart || []).forEach(function(e) {
            a = Math.max(a, e.rId),
            A += '<Relationship Id="rId'.concat(e.rId, '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart" Target="').concat(e.Target, '"/>')
        }),
        (e._relsMedia || []).forEach(function(e) {
            var t = e.rId.toString();
            a = Math.max(a, e.rId),
            e.type.toLowerCase().includes("image") ? A += '<Relationship Id="rId' + t + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="' + e.Target + '"/>': e.type.toLowerCase().includes("audio") ? A.includes(' Target="' + e.Target + '"') ? A += '<Relationship Id="rId' + t + '" Type="http://schemas.microsoft.com/office/2007/relationships/media" Target="' + e.Target + '"/>' : A += '<Relationship Id="rId' + t + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/audio" Target="' + e.Target + '"/>': e.type.toLowerCase().includes("video") ? A.includes(' Target="' + e.Target + '"') ? A += '<Relationship Id="rId' + t + '" Type="http://schemas.microsoft.com/office/2007/relationships/media" Target="' + e.Target + '"/>' : A += '<Relationship Id="rId' + t + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/video" Target="' + e.Target + '"/>': e.type.toLowerCase().includes("online") && (A.includes(' Target="' + e.Target + '"') ? A += '<Relationship Id="rId' + t + '" Type="http://schemas.microsoft.com/office/2007/relationships/image" Target="' + e.Target + '"/>': A += '<Relationship Id="rId' + t + '" Target="' + e.Target + '" TargetMode="External" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/video"/>')
        }),
        t.forEach(function(e, t) {
            A += '<Relationship Id="rId'.concat(a + t + 1, '" Type="').concat(e.type, '" Target="').concat(e.target, '"/>')
        }),
        A += "</Relationships>"
    }
    function Ue(e, t) {
        ...
        return e.options.lineSpacing ? n = '<a:lnSpc><a:spcPts val="'.concat(Math.round(100 * e.options.lineSpacing), '"/></a:lnSpc>') : e.options.lineSpacingMultiple && (n = '<a:lnSpc><a:spcPct val="'.concat(Math.round(1e5 * e.options.lineSpacingMultiple), '"/></a:lnSpc>')),
        e.options.indentLevel && !isNaN(Number(e.options.indentLevel)) && 0 < e.options.indentLevel && (s += ' lvl="'.concat(e.options.indentLevel, '"')),
        e.options.paraSpaceBefore && !isNaN(Number(e.options.paraSpaceBefore)) && 0 < e.options.paraSpaceBefore && (r += '<a:spcBef><a:spcPts val="'.concat(Math.round(100 * e.options.paraSpaceBefore), '"/></a:spcBef>')),
        e.options.paraSpaceAfter && !isNaN(Number(e.options.paraSpaceAfter)) && 0 < e.options.paraSpaceAfter && (r += '<a:spcAft><a:spcPts val="'.concat(Math.round(100 * e.options.paraSpaceAfter), '"/></a:spcAft>')),
        ...
        e.options.tabStops && Array.isArray(e.options.tabStops) && (A = e.options.tabStops.map(function(e) {
            return '<a:tab pos="'.concat(M(e.position || 1), '" algn="').concat(e.alignment || "l", '"/>')
        }).join(""), l = "<a:tabLst>".concat(A, "</a:tabLst>")),
        s += ">" + n + r + o + l,
        t && (s += Qe(e.options, !0)),
        s += "</" + c + ">"
    }
    function Qe(e, t) {
        var a, A, o, n, r = "",
        t = t ? "a:defRPr": "a:rPr",
        r = (r = (r = (r = (r += "<" + t + ' lang="' + (e.lang || "en-US") + '"' + (e.lang ? ' altLang="en-US"' : "")) + (e.fontSize ? ' sz="'.concat(Math.round(100 * e.fontSize), '"') : "")) + (null != e && e.bold ? ' b="'.concat(e.bold ? "1" : "0", '"') : "")) + (null != e && e.italic ? ' i="'.concat(e.italic ? "1" : "0", '"') : "")) + (null != e && e.strike ? ' strike="'.concat("string" == typeof e.strike ? e.strike : "sngStrike", '"') : "");
        if ("object" == typeof e.underline && null != (a = e.underline) && a.style ? r += ' u="'.concat(e.underline.style, '"') : "string" == typeof e.underline ? r += ' u="'.concat(String(e.underline), '"') : e.hyperlink && (r += ' u="sng"'), e.baseline ? r += ' baseline="'.concat(Math.round(50 * e.baseline), '"') : e.subscript ? r += ' baseline="-40000"' : e.superscript && (r += ' baseline="30000"'), r = r + (e.charSpacing ? ' spc="'.concat(Math.round(100 * e.charSpacing), '" kern="0"') : "") + ' dirty="0">', (e.color || e.fontFace || e.outline || "object" == typeof e.underline && e.underline.color) && (e.outline && "object" == typeof e.outline && (r += '<a:ln w="'.concat(O(e.outline.size || .75), '">').concat(U(e.outline.color || "FFFFFF"), "</a:ln>")), e.color && (r += U({
            color: e.color,
            transparency: e.transparency
        })), e.highlight && (r += "<a:highlight>".concat(z(e.highlight), "</a:highlight>")), "object" == typeof e.underline && e.underline.color && (r += "<a:uFill>".concat(U(e.underline.color), "</a:uFill>")), e.glow && (r += "<a:effectLst>".concat((a = e.glow, o = "", A = y(y({},
        A = re), a), a = Math.round(A.size * x), n = A.color, A = Math.round(1e5 * A.opacity), (o += '<a:glow rad="'.concat(a, '">')) + z(n, '<a:alpha val="'.concat(A, '"/>')) + "</a:glow>"), "</a:effectLst>")), e.fontFace) && (r += '<a:latin typeface="'.concat(e.fontFace, '" pitchFamily="34" charset="0"/><a:ea typeface="').concat(e.fontFace, '" pitchFamily="34" charset="-122"/><a:cs typeface="').concat(e.fontFace, '" pitchFamily="34" charset="-120"/>')), e.hyperlink) {
            if ("object" != typeof e.hyperlink) throw new Error("ERROR: text `hyperlink` option should be an object. Ex: `hyperlink:{url:'https://github.com'}` ");
            if (!e.hyperlink.url && !e.hyperlink.slide) throw new Error("ERROR: 'hyperlink requires either `url` or `slide`'");
            e.hyperlink.url ? r += '<a:hlinkClick r:id="rId'.concat(e.hyperlink._rId, '" invalidUrl="" action="" tgtFrame="" tooltip="').concat(e.hyperlink.tooltip ? I(e.hyperlink.tooltip) : "", '" history="1" highlightClick="0" endSnd="0"').concat(e.color ? ">" : "/>") : e.hyperlink.slide && (r += '<a:hlinkClick r:id="rId'.concat(e.hyperlink._rId, '" action="ppaction://hlinksldjump" tooltip="').concat(e.hyperlink.tooltip ? I(e.hyperlink.tooltip) : "", '"').concat(e.color ? ">" : "/>")),
            e.color && (r += ' <a:extLst>  <a:ext uri="{A12FA001-AC4F-418D-AE19-62706E023703}">   <ahyp:hlinkClr xmlns:ahyp="http://schemas.microsoft.com/office/drawing/2018/hyperlinkcolor" val="tx"/>  </a:ext> </a:extLst></a:hlinkClick>')
        }
        return r += "</".concat(t, ">")
    }
    function Ge(a) {
        var n, e, t, A, o, r = a.options || {},
        l = [],
        c = [];
        return !r || a._type === N.tablecell || void 0 !== a.text && null !== a.text ? (n = a._type === N.tablecell ? "<a:txBody>": "<p:txBody>", n += (t = "<a:bodyPr", (e = a) && e._type === N.text && e.options._bodyProp ? (t += e.options._bodyProp.wrap ? ' wrap="square"' : ' wrap="none"', !e.options._bodyProp.lIns && 0 !== e.options._bodyProp.lIns || (t += ' lIns="'.concat(e.options._bodyProp.lIns, '"')), !e.options._bodyProp.tIns && 0 !== e.options._bodyProp.tIns || (t += ' tIns="'.concat(e.options._bodyProp.tIns, '"')), !e.options._bodyProp.rIns && 0 !== e.options._bodyProp.rIns || (t += ' rIns="'.concat(e.options._bodyProp.rIns, '"')), !e.options._bodyProp.bIns && 0 !== e.options._bodyProp.bIns || (t += ' bIns="'.concat(e.options._bodyProp.bIns, '"')), t += ' rtlCol="0"', e.options._bodyProp.anchor && (t += ' anchor="' + e.options._bodyProp.anchor + '"'), e.options._bodyProp.vert && (t += ' vert="' + e.options._bodyProp.vert + '"'), t += ">", e.options.fit && ("none" === e.options.fit ? t += "" : "shrink" === e.options.fit ? t += "<a:normAutofit/>": "resize" === e.options.fit && (t += "<a:spAutoFit/>")), e.options.shrinkText && (t += "<a:normAutofit/>"), t = t + (e.options._bodyProp.autoFit ? "<a:spAutoFit/>": "") + "</a:bodyPr>") : t += ' wrap="square" rtlCol="0"></a:bodyPr>', e._type === N.tablecell ? "<a:bodyPr/>": t), 0 === r.h && r.line && r.align ? n += '<a:lstStyle><a:lvl1pPr algn="l"/></a:lstStyle>': "placeholder" === a._type ? n += "<a:lstStyle>".concat(Ue(a, !0), "</a:lstStyle>") : n += "<a:lstStyle/>", "string" == typeof a.text || "number" == typeof a.text ? l.push({
            text: a.text.toString(),
            options: r || {}
        }) : a.text && !Array.isArray(a.text) && "object" == typeof a.text && Object.keys(a.text).includes("text") ? l.push({
            text: a.text || "",
            options: a.options || {}
        }) : Array.isArray(a.text) && (l = a.text.map(function(e) {
            return {
                text: e.text,
                options: e.options
            }
        ...
        }), A = [], o = [], c.forEach(function(e, t) {
            0 < o.length && (e.options.align || r.align) ? e.options.align !== c[t - 1].options.align && (A.push(o), o = []) : 0 < o.length && e.options.bullet && 0 < o.length && (A.push(o), o = [], e.options.breakLine = !1),
            o.push(e),
            0 < o.length && e.options.breakLine && t + 1 < c.length && (A.push(o), o = []),
            t + 1 === c.length && A.push(o)
        }), A.forEach(function(e) {
            var t, A = !1,
            o = (n += "<a:p>", "<a:pPr ".concat(null != (t = e[0].options) && t.rtlMode ? ' rtl="1" ' : ""));
            e.forEach(function(a, e) {
                0 < (a.options._lineIdx = e) && a.options.softBreakBefore && (n += "<a:br/>"),
                a.options.align = a.options.align || r.align,
                a.options.lineSpacing = a.options.lineSpacing || r.lineSpacing,
                a.options.lineSpacingMultiple = a.options.lineSpacingMultiple || r.lineSpacingMultiple,
                a.options.indentLevel = a.options.indentLevel || r.indentLevel,
                a.options.paraSpaceBefore = a.options.paraSpaceBefore || r.paraSpaceBefore,
                a.options.paraSpaceAfter = a.options.paraSpaceAfter || r.paraSpaceAfter,
                o = Ue(a, !1),
                n += o.replace("<a:pPr></a:pPr>", ""),
                Object.entries(r).filter(function(e) {
                    var t = e[0];
                    return e[1],
                    !(a.options.hyperlink && "color" === t)
                }).forEach(function(e) {
                    var t = e[0],
                    e = e[1];
                    "bullet" === t || a.options[t] || (a.options[t] = e)
                }),
                n += (e = a).text ? "<a:r>".concat(Qe(e.options, !1), "<a:t>").concat(I(e.text), "</a:t></a:r>") : "",
                (!a.text && r.fontSize || a.options.fontSize) && (A = !0, r.fontSize = r.fontSize || a.options.fontSize)
            }),
            a._type === N.tablecell && (r.fontSize || r.fontFace) ? r.fontFace ? n = (n = (n = (n += '<a:endParaRPr lang="'.concat(r.lang || "en-US", '"') + (r.fontSize ? ' sz="'.concat(Math.round(100 * r.fontSize), '"') : "") + ' dirty="0">') + '<a:latin typeface="'.concat(r.fontFace, '" charset="0"/>')) + '<a:ea typeface="'.concat(r.fontFace, '" charset="0"/>')) + '<a:cs typeface="'.concat(r.fontFace, '" charset="0"/>') + "</a:endParaRPr>": n += '<a:endParaRPr lang="'.concat(r.lang || "en-US", '"') + (r.fontSize ? ' sz="'.concat(Math.round(100 * r.fontSize), '"') : "") + ' dirty="0"/>': n += A ? '<a:endParaRPr lang="'.concat(r.lang || "en-US", '"') + (r.fontSize ? ' sz="'.concat(Math.round(100 * r.fontSize), '"') : "") + ' dirty="0"/>': '<a:endParaRPr lang="'.concat(r.lang || "en-US", '" dirty="0"/>'),
            n += "</a:p>"
        }), n += a._type === N.tablecell ? "</a:txBody>": "</p:txBody>") : ""
    }
    function je(e) {
        var t, a;
        return e ? (t = null != (t = e.options) && t._placeholderIdx ? e.options._placeholderIdx : "", a = (a = null != (a = e.options) && a._placeholderType ? e.options._placeholderType : "") && o[a] ? o[a].toString() : "", "<p:ph\n\t\t".concat(t ? ' idx="' + t.toString() + '"' : "", "\n\t\t").concat(a && o[a] ? ' type="'.concat(a, '"') : "", "\n\t\t").concat(e.text && 0 < e.text.length ? ' hasCustomPrompt="1"' : "", "\n\t\t/>")) : ""
    }
    function Ye(e) {
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u, '<p:notes xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"><p:cSld><p:spTree><p:nvGrpSpPr><p:cNvPr id="1" name=""/><p:cNvGrpSpPr/><p:nvPr/></p:nvGrpSpPr><p:grpSpPr><a:xfrm><a:off x="0" y="0"/><a:ext cx="0" cy="0"/><a:chOff x="0" y="0"/><a:chExt cx="0" cy="0"/></a:xfrm></p:grpSpPr><p:sp><p:nvSpPr><p:cNvPr id="2" name="Slide Image Placeholder 1"/><p:cNvSpPr><a:spLocks noGrp="1" noRot="1" noChangeAspect="1"/></p:cNvSpPr><p:nvPr><p:ph type="sldImg"/></p:nvPr></p:nvSpPr><p:spPr/></p:sp><p:sp><p:nvSpPr><p:cNvPr id="3" name="Notes Placeholder 2"/><p:cNvSpPr><a:spLocks noGrp="1"/></p:cNvSpPr><p:nvPr><p:ph type="body" idx="1"/></p:nvPr></p:nvSpPr><p:spPr/><p:txBody><a:bodyPr/><a:lstStyle/><a:p><a:r><a:rPr lang="en-US" dirty="0"/><a:t>').concat(I((t = "", e._slideObjects.forEach(function(e) {
            e._type === N.notes && (t += null != e && e.text && e.text[0] ? e.text[0].text : "")
    ...
    function Xe(e, t, a) {
        return ze(e[a - 1], [{
            target: "../slideLayouts/slideLayout".concat(function(e, t, a) {
                for (var A = 0; A < t.length; A++) if (t[A]._name === e[a - 1]._slideLayout._name) return A + 1;
                return 1
            } (e, t, a), ".xml"),
    ...
    function a() {
        var a = this;
        this._version = "3.13.0-beta.0-20230416-2140",
        this._alignH = j,
        this._alignV = Y,
        this._chartType = E,
        this._outputType = S,
        ...
        this.addNewSlide = function(e) {
            var t = 0 < a.sections.length && 0 < a.sections[a.sections.length - 1]._slides.filter(function(e) {
                return e._slideNum === a.slides[a.slides.length - 1]._slideNum
            }).length;
            return e.sectionTitle = t ? a.sections[a.sections.length - 1].title : null,
            a.addSlide(e)
        },
        ...
        this.createChartMediaRels = function(e, a, t) {
            ...
            e._relsMedia.forEach(function(e) {
                var t;
                "online" !== e.type && "hyperlink" !== e.type && (((t = e.data && "string" == typeof e.data ? e.data : "").includes(",") || t.includes(";")) && t.includes(",") ? t.includes(";") || (t = "image/png;" + t) : t = "image/png;base64," + t, a.file(e.Target.replace("..", "ppt"), t.split(",").pop(), {
                    base64: !0
                }))
            })
        },
        this.writeFileToBrowser = function(A, o) {
            return p(a, void 0, void 0, function() {
                ...
                return d(this, function(e) {
                    switch (e.label) {
                    case 0:
                        return ((t = document.createElement("a")).setAttribute("style", "display:none;"), t.dataset.interception = "off", document.body.appendChild(t), window.URL.createObjectURL) ? (a = window.URL.createObjectURL(new Blob([o], {
                            type: "application/vnd.openxmlformats-officedocument.presentationml.presentation"
                        })), t.href = a, t.download = A, t.click(), setTimeout(function() {
                            window.URL.revokeObjectURL(a),
                            document.body.removeChild(t)
                        },
                        100), [4, Promise.resolve(A)]) : [3, 2];
                    case 1:
                        return [2, e.sent()];
                    case 2:
                        return [2]
                                ...
                                return d(this, function(e) {
                                    ...
                                    case 0:
                                        return this.slides.forEach(function(e) {
                                            var a;
                                            e._slideLayout && ((a = e)._slideLayout._slideObjects || []).forEach(function(t) {
                                                t._type === N.placeholder && 0 === a._slideObjects.filter(function(e) {
                                        ...
                                        i.file("[Content_Types].xml", (A = this.slides, o = this.slideLayouts, n = this.masterSlide, r = (r = (r = (r = (r = (r = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + u) + '<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Default Extension="xml" ContentType="application/xml"/>') + '<Default Extension="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml"/><Default Extension="jpeg" ContentType="image/jpeg"/>') + '<Default Extension="jpg" ContentType="image/jpg"/><Default Extension="svg" ContentType="image/svg+xml"/>') + '<Default Extension="png" ContentType="image/png"/><Default Extension="gif" ContentType="image/gif"/>') + '<Default Extension="m4v" ContentType="video/mp4"/><Default Extension="mp4" ContentType="video/mp4"/>', A.forEach(function(e) {
                                            (e._relsMedia || []).forEach(function(e) {
                                                "image" === e.type || "online" === e.type || "chart" === e.type || "m4v" === e.extn || r.includes(e.type) || (r += '<Default Extension="' + e.extn + '" ContentType="' + e.type + '"/>')
                                            })
                                        }), r = (r += '<Default Extension="vml" ContentType="application/vnd.openxmlformats-officedocument.vmlDrawing"/><Default Extension="xlsx" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"/>') + '<Override PartName="/ppt/presentation.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.presentation.main+xml"/><Override PartName="/ppt/notesMasters/notesMaster1.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.notesMaster+xml"/>', A.forEach(function(e, t) {
                                            r = (r += '<Override PartName="/ppt/slideMasters/slideMaster'.concat(t + 1, '.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"/>')) + '<Override PartName="/ppt/slides/slide'.concat(t + 1, '.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slide+xml"/>'),
                                            e._relsChart.forEach(function(e) {
                                                r += '<Override PartName="'.concat(e.Target, '" ContentType="application/vnd.openxmlformats-officedocument.drawingml.chart+xml"/>')
                                            })
                                        }), r = (r += '<Override PartName="/ppt/presProps.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.presProps+xml"/><Override PartName="/ppt/viewProps.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.viewProps+xml"/>') + '<Override PartName="/ppt/theme/theme1.xml" ContentType="application/vnd.openxmlformats-officedocument.theme+xml"/><Override PartName="/ppt/tableStyles.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.tableStyles+xml"/>', o.forEach(function(e, t) {
                                            r += '<Override PartName="/ppt/slideLayouts/slideLayout'.concat(t + 1, '.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"/>'),
                                            (e._relsChart || []).forEach(function(e) {
                                                r += ' <Override PartName="' + e.Target + '" ContentType="application/vnd.openxmlformats-officedocument.drawingml.chart+xml"/>'
                                            })
                                        }), A.forEach(function(e, t) {
                                            r += '<Override PartName="/ppt/notesSlides/notesSlide'.concat(t + 1, '.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.notesSlide+xml"/>')
                                        }), n._relsChart.forEach(function(e) {
                                            r += ' <Override PartName="' + e.Target + '" ContentType="application/vnd.openxmlformats-officedocument.drawingml.chart+xml"/>'
                                        }), n._relsMedia.forEach(function(e) {
                                            "image" === e.type || "online" === e.type || "chart" === e.type || "m4v" === e.extn || r.includes(e.type) || (r += ' <Default Extension="' + e.extn + '" ContentType="' + e.type + '"/>')
                                        }), r = (r += ' <Override PartName="/docProps/core.xml" ContentType="application/vnd.openxmlformats-package.core-properties+xml"/>') + ' <Override PartName="/docProps/app.xml" ContentType="application/vnd.openxmlformats-officedocument.extended-properties+xml"/></Types>')),
                                        i.file("_rels/.rels", '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u, '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">\n\t\t<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties" Target="docProps/app.xml"/>\n\t\t<Relationship Id="rId2" Type="http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties" Target="docProps/core.xml"/>\n\t\t<Relationship Id="rId3" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="ppt/presentation.xml"/>\n\t\t</Relationships>')),
                                        i.file("docProps/app.xml", (o = this.slides, A = this.company, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u, '<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">\n\t<TotalTime>0</TotalTime>\n\t<Words>0</Words>\n\t<Application>Microsoft Office PowerPoint</Application>\n\t<PresentationFormat>On-screen Show (16:9)</PresentationFormat>\n\t<Paragraphs>0</Paragraphs>\n\t<Slides>').concat(o.length, "</Slides>\n\t<Notes>").concat(o.length, '</Notes>\n\t<HiddenSlides>0</HiddenSlides>\n\t<MMClips>0</MMClips>\n\t<ScaleCrop>false</ScaleCrop>\n\t<HeadingPairs>\n\t\t<vt:vector size="6" baseType="variant">\n\t\t\t<vt:variant><vt:lpstr>Fonts Used</vt:lpstr></vt:variant>\n\t\t\t<vt:variant><vt:i4>2</vt:i4></vt:variant>\n\t\t\t<vt:variant><vt:lpstr>Theme</vt:lpstr></vt:variant>\n\t\t\t<vt:variant><vt:i4>1</vt:i4></vt:variant>\n\t\t\t<vt:variant><vt:lpstr>Slide Titles</vt:lpstr></vt:variant>\n\t\t\t<vt:variant><vt:i4>').concat(o.length, '</vt:i4></vt:variant>\n\t\t</vt:vector>\n\t</HeadingPairs>\n\t<TitlesOfParts>\n\t\t<vt:vector size="').concat(o.length + 1 + 2, '" baseType="lpstr">\n\t\t\t<vt:lpstr>Arial</vt:lpstr>\n\t\t\t<vt:lpstr>Calibri</vt:lpstr>\n\t\t\t<vt:lpstr>Office Theme</vt:lpstr>\n\t\t\t').concat(o.map(function(e, t) {
                                            return "<vt:lpstr>Slide ".concat(t + 1, "</vt:lpstr>")
                                        }).join(""), "\n\t\t</vt:vector>\n\t</TitlesOfParts>\n\t<Company>").concat(A, "</Company>\n\t<LinksUpToDate>false</LinksUpToDate>\n\t<SharedDoc>false</SharedDoc>\n\t<HyperlinksChanged>false</HyperlinksChanged>\n\t<AppVersion>16.0000</AppVersion>\n\t</Properties>"))),
                                        i.file("docProps/core.xml", (n = this.title, o = this.subject, A = this.author, t = this.revision, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n\t<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">\n\t\t<dc:title>'.concat(I(n), "</dc:title>\n\t\t<dc:subject>").concat(I(o), "</dc:subject>\n\t\t<dc:creator>").concat(I(A), "</dc:creator>\n\t\t<cp:lastModifiedBy>").concat(I(A), "</cp:lastModifiedBy>\n\t\t<cp:revision>").concat(t, '</cp:revision>\n\t\t<dcterms:created xsi:type="dcterms:W3CDTF">').concat((new Date).toISOString().replace(/\.\d\d\dZ/, "Z"), '</dcterms:created>\n\t\t<dcterms:modified xsi:type="dcterms:W3CDTF">').concat((new Date).toISOString().replace(/\.\d\d\dZ/, "Z"), "</dcterms:modified>\n\t</cp:coreProperties>"))),
                                        i.file("ppt/_rels/presentation.xml.rels", function(e) {
                                            for (var t = 1, a = (a = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + u) + '<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">' + '<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideMaster" Target="slideMasters/slideMaster1.xml"/>', A = 1; A <= e.length; A++) a += '<Relationship Id="rId'.concat(++t, '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide" Target="slides/slide').concat(A, '.xml"/>');
                                        ...
                                        i.file("ppt/theme/theme1.xml", (o = null != (o = (n = this).theme) && o.headFontFace ? '<a:latin typeface="'.concat(null == (o = n.theme) ? void 0 : o.headFontFace, '"/>') : '<a:latin typeface="Calibri Light" panose="020F0302020204030204"/>', n = null != (A = n.theme) && A.bodyFontFace ? '<a:latin typeface="'.concat(null == (A = n.theme) ? void 0 : A.bodyFontFace, '"/>') : '<a:latin typeface="Calibri" panose="020F0502020204030204"/>', '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="Office Theme"><a:themeElements><a:clrScheme name="Office"><a:dk1><a:sysClr val="windowText" lastClr="000000"/></a:dk1><a:lt1><a:sysClr val="window" lastClr="FFFFFF"/></a:lt1><a:dk2><a:srgbClr val="44546A"/></a:dk2><a:lt2><a:srgbClr val="E7E6E6"/></a:lt2><a:accent1><a:srgbClr val="4472C4"/></a:accent1><a:accent2><a:srgbClr val="ED7D31"/></a:accent2><a:accent3><a:srgbClr val="A5A5A5"/></a:accent3><a:accent4><a:srgbClr val="FFC000"/></a:accent4><a:accent5><a:srgbClr val="5B9BD5"/></a:accent5><a:accent6><a:srgbClr val="70AD47"/></a:accent6><a:hlink><a:srgbClr val="0563C1"/></a:hlink><a:folHlink><a:srgbClr val="954F72"/></a:folHlink></a:clrScheme><a:fontScheme name="Office"><a:majorFont>'.concat(o, '<a:ea typeface=""/><a:cs typeface=""/><a:font script="Jpan" typeface="游ゴシック Light"/><a:font script="Hang" typeface="맑은 고딕"/><a:font script="Hans" typeface="等线 Light"/><a:font script="Hant" typeface="新細明體"/><a:font script="Arab" typeface="Times New Roman"/><a:font script="Hebr" typeface="Times New Roman"/><a:font script="Thai" typeface="Angsana New"/><a:font script="Ethi" typeface="Nyala"/><a:font script="Beng" typeface="Vrinda"/><a:font script="Gujr" typeface="Shruti"/><a:font script="Khmr" typeface="MoolBoran"/><a:font script="Knda" typeface="Tunga"/><a:font script="Guru" typeface="Raavi"/><a:font script="Cans" typeface="Euphemia"/><a:font script="Cher" typeface="Plantagenet Cherokee"/><a:font script="Yiii" typeface="Microsoft Yi Baiti"/><a:font script="Tibt" typeface="Microsoft Himalaya"/><a:font script="Thaa" typeface="MV Boli"/><a:font script="Deva" typeface="Mangal"/><a:font script="Telu" typeface="Gautami"/><a:font script="Taml" typeface="Latha"/><a:font script="Syrc" typeface="Estrangelo Edessa"/><a:font script="Orya" typeface="Kalinga"/><a:font script="Mlym" typeface="Kartika"/><a:font script="Laoo" typeface="DokChampa"/><a:font script="Sinh" typeface="Iskoola Pota"/><a:font script="Mong" typeface="Mongolian Baiti"/><a:font script="Viet" typeface="Times New Roman"/><a:font script="Uigh" typeface="Microsoft Uighur"/><a:font script="Geor" typeface="Sylfaen"/><a:font script="Armn" typeface="Arial"/><a:font script="Bugi" typeface="Leelawadee UI"/><a:font script="Bopo" typeface="Microsoft JhengHei"/><a:font script="Java" typeface="Javanese Text"/><a:font script="Lisu" typeface="Segoe UI"/><a:font script="Mymr" typeface="Myanmar Text"/><a:font script="Nkoo" typeface="Ebrima"/><a:font script="Olck" typeface="Nirmala UI"/><a:font script="Osma" typeface="Ebrima"/><a:font script="Phag" typeface="Phagspa"/><a:font script="Syrn" typeface="Estrangelo Edessa"/><a:font script="Syrj" typeface="Estrangelo Edessa"/><a:font script="Syre" typeface="Estrangelo Edessa"/><a:font script="Sora" typeface="Nirmala UI"/><a:font script="Tale" typeface="Microsoft Tai Le"/><a:font script="Talu" typeface="Microsoft New Tai Lue"/><a:font script="Tfng" typeface="Ebrima"/></a:majorFont><a:minorFont>').concat(n, '<a:ea typeface=""/><a:cs typeface=""/><a:font script="Jpan" typeface="游ゴシック"/><a:font script="Hang" typeface="맑은 고딕"/><a:font script="Hans" typeface="等线"/><a:font script="Hant" typeface="新細明體"/><a:font script="Arab" typeface="Arial"/><a:font script="Hebr" typeface="Arial"/><a:font script="Thai" typeface="Cordia New"/><a:font script="Ethi" typeface="Nyala"/><a:font script="Beng" typeface="Vrinda"/><a:font script="Gujr" typeface="Shruti"/><a:font script="Khmr" typeface="DaunPenh"/><a:font script="Knda" typeface="Tunga"/><a:font script="Guru" typeface="Raavi"/><a:font script="Cans" typeface="Euphemia"/><a:font script="Cher" typeface="Plantagenet Cherokee"/><a:font script="Yiii" typeface="Microsoft Yi Baiti"/><a:font script="Tibt" typeface="Microsoft Himalaya"/><a:font script="Thaa" typeface="MV Boli"/><a:font script="Deva" typeface="Mangal"/><a:font script="Telu" typeface="Gautami"/><a:font script="Taml" typeface="Latha"/><a:font script="Syrc" typeface="Estrangelo Edessa"/><a:font script="Orya" typeface="Kalinga"/><a:font script="Mlym" typeface="Kartika"/><a:font script="Laoo" typeface="DokChampa"/><a:font script="Sinh" typeface="Iskoola Pota"/><a:font script="Mong" typeface="Mongolian Baiti"/><a:font script="Viet" typeface="Arial"/><a:font script="Uigh" typeface="Microsoft Uighur"/><a:font script="Geor" typeface="Sylfaen"/><a:font script="Armn" typeface="Arial"/><a:font script="Bugi" typeface="Leelawadee UI"/><a:font script="Bopo" typeface="Microsoft JhengHei"/><a:font script="Java" typeface="Javanese Text"/><a:font script="Lisu" typeface="Segoe UI"/><a:font script="Mymr" typeface="Myanmar Text"/><a:font script="Nkoo" typeface="Ebrima"/><a:font script="Olck" typeface="Nirmala UI"/><a:font script="Osma" typeface="Ebrima"/><a:font script="Phag" typeface="Phagspa"/><a:font script="Syrn" typeface="Estrangelo Edessa"/><a:font script="Syrj" typeface="Estrangelo Edessa"/><a:font script="Syre" typeface="Estrangelo Edessa"/><a:font script="Sora" typeface="Nirmala UI"/><a:font script="Tale" typeface="Microsoft Tai Le"/><a:font script="Talu" typeface="Microsoft New Tai Lue"/><a:font script="Tfng" typeface="Ebrima"/></a:minorFont></a:fontScheme><a:fmtScheme name="Office"><a:fillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:gradFill rotWithShape="1"><a:gsLst><a:gs pos="0"><a:schemeClr val="phClr"><a:lumMod val="110000"/><a:satMod val="105000"/><a:tint val="67000"/></a:schemeClr></a:gs><a:gs pos="50000"><a:schemeClr val="phClr"><a:lumMod val="105000"/><a:satMod val="103000"/><a:tint val="73000"/></a:schemeClr></a:gs><a:gs pos="100000"><a:schemeClr val="phClr"><a:lumMod val="105000"/><a:satMod val="109000"/><a:tint val="81000"/></a:schemeClr></a:gs></a:gsLst><a:lin ang="5400000" scaled="0"/></a:gradFill><a:gradFill rotWithShape="1"><a:gsLst><a:gs pos="0"><a:schemeClr val="phClr"><a:satMod val="103000"/><a:lumMod val="102000"/><a:tint val="94000"/></a:schemeClr></a:gs><a:gs pos="50000"><a:schemeClr val="phClr"><a:satMod val="110000"/><a:lumMod val="100000"/><a:shade val="100000"/></a:schemeClr></a:gs><a:gs pos="100000"><a:schemeClr val="phClr"><a:lumMod val="99000"/><a:satMod val="120000"/><a:shade val="78000"/></a:schemeClr></a:gs></a:gsLst><a:lin ang="5400000" scaled="0"/></a:gradFill></a:fillStyleLst><a:lnStyleLst><a:ln w="6350" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln><a:ln w="12700" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln><a:ln w="19050" cap="flat" cmpd="sng" algn="ctr"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:prstDash val="solid"/><a:miter lim="800000"/></a:ln></a:lnStyleLst><a:effectStyleLst><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst/></a:effectStyle><a:effectStyle><a:effectLst><a:outerShdw blurRad="57150" dist="19050" dir="5400000" algn="ctr" rotWithShape="0"><a:srgbClr val="000000"><a:alpha val="63000"/></a:srgbClr></a:outerShdw></a:effectLst></a:effectStyle></a:effectStyleLst><a:bgFillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill><a:solidFill><a:schemeClr val="phClr"><a:tint val="95000"/><a:satMod val="170000"/></a:schemeClr></a:solidFill><a:gradFill rotWithShape="1"><a:gsLst><a:gs pos="0"><a:schemeClr val="phClr"><a:tint val="93000"/><a:satMod val="150000"/><a:shade val="98000"/><a:lumMod val="102000"/></a:schemeClr></a:gs><a:gs pos="50000"><a:schemeClr val="phClr"><a:tint val="98000"/><a:satMod val="130000"/><a:shade val="90000"/><a:lumMod val="103000"/></a:schemeClr></a:gs><a:gs pos="100000"><a:schemeClr val="phClr"><a:shade val="63000"/><a:satMod val="120000"/></a:schemeClr></a:gs></a:gsLst><a:lin ang="5400000" scaled="0"/></a:gradFill></a:bgFillStyleLst></a:fmtScheme></a:themeElements><a:objectDefaults/><a:extraClrSchemeLst/><a:extLst><a:ext uri="{05A4C25C-085E-4340-85A3-A5531E510DB2}"><thm15:themeFamily xmlns:thm15="http://schemas.microsoft.com/office/thememl/2012/main" name="Office Theme" id="{62F939B6-93AF-4DB8-9C6B-D6C7DFDC589F}" vid="{4A3C46E8-61CC-4603-A589-7422A47A8E4A}"/></a:ext></a:extLst></a:theme>'))),
                                        i.file("ppt/presentation.xml", function(e) {
                                            var t = (t = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u) + '<p:presentation xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" ' + 'xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" '.concat(e.rtlMode ? 'rtl="1"' : "", ' saveSubsetFonts="1" autoCompressPictures="0">')) + '<p:sldMasterIdLst><p:sldMasterId id="2147483648" r:id="rId1"/></p:sldMasterIdLst>' + "<p:sldIdLst>";
                                            e.slides.forEach(function(e) {
                                                return t += '<p:sldId id="'.concat(e._slideId, '" r:id="rId').concat(e._rId, '"/>')
                                            }),
                                            t = (t = (t = (t += "</p:sldIdLst>") + '<p:notesMasterIdLst><p:notesMasterId r:id="rId'.concat(e.slides.length + 2, '"/></p:notesMasterIdLst>')) + '<p:sldSz cx="'.concat(e.presLayout.width, '" cy="').concat(e.presLayout.height, '"/>')) + '<p:notesSz cx="'.concat(e.presLayout.height, '" cy="').concat(e.presLayout.width, '"/>') + "<p:defaultTextStyle>";
                                            for (var a = 1; a < 10; a++) t += "<a:lvl".concat(a, 'pPr marL="').concat(457200 * (a - 1), '" algn="l" defTabSz="914400" rtl="0" eaLnBrk="1" latinLnBrk="0" hangingPunct="1">') + '<a:defRPr sz="1800" kern="1200"><a:solidFill><a:schemeClr val="tx1"/></a:solidFill><a:latin typeface="+mn-lt"/><a:ea typeface="+mn-ea"/><a:cs typeface="+mn-cs"/>' + "</a:defRPr></a:lvl".concat(a, "pPr>");
                                            return t += "</p:defaultTextStyle>",
                                            e.sections && 0 < e.sections.length && (t += '<p:extLst><p:ext uri="{521415D9-36F7-43E2-AB2F-B90AF26B5E84}"><p14:sectionLst xmlns:p14="http://schemas.microsoft.com/office/powerpoint/2010/main">', e.sections.forEach(function(e) {
                                                t += '<p14:section name="'.concat(I(e.title), '" id="{').concat(he("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"), '}"><p14:sldIdLst>'),
                                                e._slides.forEach(function(e) {
                                                    return t += '<p14:sldId id="'.concat(e._slideId, '"/>')
                                                }),
                                                t += "</p14:sldIdLst></p14:section>"
                                            }), t += '</p14:sectionLst></p:ext><p:ext uri="{EFAFB233-063F-42B5-8137-9DF3F51BA10A}"><p15:sldGuideLst xmlns:p15="http://schemas.microsoft.com/office/powerpoint/2012/main"/></p:ext></p:extLst>'),
                                            t += "</p:presentation>"
                                        } (this)),
                                        i.file("ppt/presProps.xml", '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u, '<p:presentationPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"/>')),
                                        i.file("ppt/tableStyles.xml", '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u, '<a:tblStyleLst xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" def="{5C22544A-7EE6-4342-B048-85BDC9FD1C3A}"/>')),
                                        i.file("ppt/viewProps.xml", '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u, '<p:viewPr xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"><p:normalViewPr horzBarState="maximized"><p:restoredLeft sz="15611"/><p:restoredTop sz="94610"/></p:normalViewPr><p:slideViewPr><p:cSldViewPr snapToGrid="0" snapToObjects="1"><p:cViewPr varScale="1"><p:scale><a:sx n="136" d="100"/><a:sy n="136" d="100"/></p:scale><p:origin x="216" y="312"/></p:cViewPr><p:guideLst/></p:cSldViewPr></p:slideViewPr><p:notesTextViewPr><p:cViewPr><p:scale><a:sx n="1" d="1"/><a:sy n="1" d="1"/></p:scale><p:origin x="0" y="0"/></p:cViewPr></p:notesTextViewPr><p:gridSpacing cx="76200" cy="76200"/></p:viewPr>')),
                                        this.slideLayouts.forEach(function(e, t) {
                                            i.file("ppt/slideLayouts/slideLayout".concat(t + 1, ".xml"), '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n\t\t<p:sldLayout xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" preserve="1">\n\t\t'.concat(ke(e), "\n\t\t<p:clrMapOvr><a:masterClrMapping/></p:clrMapOvr></p:sldLayout>")),
                                            i.file("ppt/slideLayouts/_rels/slideLayout".concat(t + 1, ".xml.rels"), (e = t + 1, ze(l.slideLayouts[e - 1], [{
                                        ...
                                        this.slides.forEach(function(e, t) {
                                            var a;
                                            i.file("ppt/slides/slide".concat(t + 1, ".xml"), (a = e, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'.concat(u) + '<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main"' + "".concat(null != a && a.hidden ? ' show="0"' : "", ">") + "".concat(ke(a)) + "<p:clrMapOvr><a:masterClrMapping/></p:clrMapOvr></p:sld>")),
                                            i.file("ppt/slides/_rels/slide".concat(t + 1, ".xml.rels"), Xe(l.slides, l.slideLayouts, t + 1)),
                                            i.file("ppt/notesSlides/notesSlide".concat(t + 1, ".xml"), Ye(e)),
                                        ...
                                        this.createChartMediaRels(this.masterSlide, i, c),
                                        [4, Promise.all(c).then(function() {
                                            return p(l, void 0, void 0, function() {
                                                return d(this, function(e) {
                                                    switch (e.label) {
                                                    case 0:
                                                        return "STREAM" !== s.outputType ? [3, 2] : [4, i.generateAsync({
                                                            type: "nodebuffer",
                                                    ...
                                                    case 1:
                                                        return [2, e.sent()];
                                                    case 2:
                                                        return s.outputType ? [4, i.generateAsync({
                                                            type: s.outputType
                                                        })] : [3, 4];
                                                    case 3:
                                                        return [2, e.sent()];
                                                    case 4:
                                                        return [4, i.generateAsync({
                                                            type: "blob",
                                                            compression: s.compression ? "DEFLATE" : "STORE"
                                                        })];
                                                    case 5:
    ...
    return Object.defineProperty(a.prototype, "layout", {
        get: function() {
            return this._layout
        },
        set: function(e) {
    ...
    a.prototype.write = function(A) {
        return p(this, void 0, void 0, function() {
            ...
            return d(this, function(e) {
                switch (e.label) {
                case 0:
                    return t = "object" == typeof A && null != A && A.outputType ? A.outputType : A || null,
                    a = !("object" != typeof A || null == A || !A.compression) && A.compression,
                    [4, this.exportPresentation({
                        compression: a,
                        outputType: t
                    })];
                case 1:
    ...
    a.prototype.writeFile = function(A) {
        return p(this, void 0, void 0, function() {
            ...
            return d(this, function(e) {
                switch (e.label) {
                case 0:
                    return o = "undefined" != typeof require && "undefined" == typeof window ? require("fs") : null,
                    "string" == typeof A && console.log("Warning: `writeFile(filename)` is deprecated - please use `WriteFileProps` argument (v3.5.0)"),
                    t = "object" == typeof A && null != A && A.fileName ? A.fileName : "string" == typeof A ? A : "",
                    a = !("object" != typeof A || null == A || !A.compression) && A.compression,
                    n = t ? t.toString().toLowerCase().endsWith(".pptx") ? t : t + ".pptx" : "Presentation.pptx",
                    [4, this.exportPresentation({
                        compression: a,
                        ...
                        return p(r, void 0, void 0, function() {
                            return d(this, function(e) {
                                switch (e.label) {
                                case 0:
                                    return o ? [4, new Promise(function(t, a) {
    ...
    a.prototype.addSlide = function(t) {
        var a = "string" == typeof t ? t : null != t && t.masterName ? t.masterName : "",
        e = {
        ...
        A = (a && (A = this.slideLayouts.filter(function(e) {
            return e._name === a
        })[0]) && (e = A), new Be({
        ...
        return this._slides.push(A),
        null != t && t.sectionTitle ? (e = this.sections.filter(function(e) {
            return e.title === t.sectionTitle
        })[0]) ? e._slides.push(A) : console.warn('addSlide: unable to find section with title: "'.concat(t.sectionTitle, '"')) : this.sections && 0 < this.sections.length && (null == t || !t.sectionTitle) && ("default" === (e = this._sections[this.sections.length - 1])._type ? e._slides.push(A) : this._sections.push({
    ...
    a.prototype.defineSlideMaster = function(e) {
        if (!e.title) throw new Error("defineSlideMaster() object argument requires a `title` value. (https://gitbrent.github.io/PptxGenJS/docs/masters.html)");
        var t, o, a = {
            _margin: e.margin || oe,
            _name: e.title,
            _presLayout: this.presLayout,
        ...
        t.objects && Array.isArray(t.objects) && 0 < t.objects.length && t.objects.forEach(function(e, t) {
            var a = Object.keys(e)[0],
            A = o;
            n[a] && "chart" === a ? xe(A, e[a].type, e[a].data, e[a].opts) : n[a] && "image" === a ? Ce(A, e[a]) : n[a] && "line" === a ? we(A, c.LINE, e[a]) : n[a] && "rect" === a ? we(A, c.RECTANGLE, e[a]) : n[a] && "text" === a ? Pe(A, [{
                text: e[a].text
            }], e[a].options, !1) : n[a] && "placeholder" === a && (e[a].options.placeholder = e[a].options.name, delete e[a].options.name, e[a].options._placeholderType = e[a].options.type, delete e[a].options.type, e[a].options._placeholderIdx = 100 + t, Pe(A, [{
                text: e[a].text
            }], e[a].options, !0))
        }),
        t.slideNumber && "object" == typeof t.slideNumber && (o._slideNumberProps = t.slideNumber),
        this.slideLayouts.push(a),
        (e.background || e.bkgd) && Le(e.background, a),
        a._slideNumberProps && !this.masterSlide._slideNumberProps && (this.masterSlide._slideNumberProps = a._slideNumberProps)
    },
    a.prototype.tableToSlides = function(e, t) {
        var o, A = this,
        n = e,
        e = t = void 0 === t ? {} : t,
        a = null != t && t.masterSlideName ? this.slideLayouts.filter(function(e) {
            return e._name === t.masterSlideName
        })[0] : null,
        r = (e = void 0 === e ? {} : e) || {},
        l = (r.slideMargin = r.slideMargin || 0 === r.slideMargin ? r.slideMargin : .5, r.w || A.presLayout.width, []),
        c = [],
        i = [],
        s = [],
        p = [],
        d = [.5, .5, .5, .5],
        f = 0;
        if (!document.getElementById(n)) throw new Error('tableToSlides: Table ID "' + n + '" does not exist!');
        null != a && a._margin ? (Array.isArray(a._margin) ? d = a._margin : isNaN(a._margin) || (d = [a._margin, a._margin, a._margin, a._margin]), r.slideMargin = d) : null != r && r.slideMargin && (Array.isArray(r.slideMargin) ? d = r.slideMargin : isNaN(r.slideMargin) || (d = [r.slideMargin, r.slideMargin, r.slideMargin, r.slideMargin])),
        o = (r.w ? M(r.w) : A.presLayout.width) - M(d[1] + d[3]),
        r.verbose && (console.log("[[VERBOSE MODE]]"), console.log("|-- `tableToSlides` ----------------------------------------------------|"), console.log("| tableProps.h .................................... = ".concat(r.h)), console.log("| tableProps.w .................................... = ".concat(r.w)), console.log("| pptx.presLayout.width ........................... = ".concat((A.presLayout.width / F).toFixed(1))), console.log("| pptx.presLayout.height .......................... = ".concat((A.presLayout.height / F).toFixed(1))), console.log("| emuSlideTabW .................................... = ".concat((o / F).toFixed(1)))),
        (e = 0 === (e = document.querySelectorAll("#".concat(n, " tr:first-child th"))).length ? document.querySelectorAll("#".concat(n, " tr:first-child td")) : e).forEach(function(e) {
            if (e.getAttribute("colspan")) for (var t = 0; t < Number(e.getAttribute("colspan")); t++) p.push(Math.round(e.offsetWidth / Number(e.getAttribute("colspan"))));
        ...
        p.forEach(function(e, t) {
            ...
            a = 0,
            A = document.querySelector("#".concat(n, " thead tr:first-child th:nth-child(").concat(t + 1, ")")),
            A = (A && (a = Number(A.getAttribute("data-pptx-min-width"))), document.querySelector("#".concat(n, " thead tr:first-child th:nth-child(").concat(t + 1, ")")));
            A && (a = Number(A.getAttribute("data-pptx-width"))),
            s.push(e < a ? a : e)
        }),
        r.verbose && console.log("| arrColW ......................................... = [".concat(s.join(", "), "]")),
        ["thead", "tbody", "tfoot"].forEach(function(t) {
            document.querySelectorAll("#".concat(n, " ").concat(t, " tr")).forEach(function(e) {
                var a = [];
                switch (Array.from(e.cells).forEach(function(A) {
                    var e = window.getComputedStyle(A).getPropertyValue("color").replace(/\s+/gi, "").replace("rgba(", "").replace("rgb(", "").replace(")", "").split(","),
                    t = window.getComputedStyle(A).getPropertyValue("background-color").replace(/\s+/gi, "").replace("rgba(", "").replace("rgb(", "").replace(")", "").split(","),
                    o = ("rgba(0, 0, 0, 0)" !== window.getComputedStyle(A).getPropertyValue("background-color") && !window.getComputedStyle(A).getPropertyValue("transparent") || (t = ["255", "255", "255"]), {
                        align: null,
                        bold: !!("bold" === window.getComputedStyle(A).getPropertyValue("font-weight") || 500 <= Number(window.getComputedStyle(A).getPropertyValue("font-weight"))),
                        border: null,
                        color: me(Number(e[0]), Number(e[1]), Number(e[2])),
                        fill: {
                            color: me(Number(t[0]), Number(t[1]), Number(t[2]))
                        },
                        fontFace: (window.getComputedStyle(A).getPropertyValue("font-family") || "").split(",")[0].replace(/"/g, "").replace("inherit", "").replace("initial", "") || null,
                        fontSize: Number(window.getComputedStyle(A).getPropertyValue("font-size").replace(/[a-z]/gi, "")),
                        margin: null,
                        colspan: Number(A.getAttribute("colspan")) || null,
                        rowspan: Number(A.getAttribute("rowspan")) || null,
                        valign: null
                    });
                    ["left", "center", "right", "start", "end"].includes(window.getComputedStyle(A).getPropertyValue("text-align")) && (e = window.getComputedStyle(A).getPropertyValue("text-align").replace("start", "left").replace("end", "right"), o.align = "center" === e ? "center" : "left" === e ? "left" : "right" === e ? "right" : null),
                    ["top", "middle", "bottom"].includes(window.getComputedStyle(A).getPropertyValue("vertical-align")) && (t = window.getComputedStyle(A).getPropertyValue("vertical-align"), o.valign = "top" === t ? "top" : "middle" === t ? "middle" : "bottom" === t ? "bottom" : null),
                    window.getComputedStyle(A).getPropertyValue("padding-left") && (o.margin = [0, 0, 0, 0], ["padding-top", "padding-right", "padding-bottom", "padding-left"].forEach(function(e, t) {
                        o.margin[t] = Math.round(Number(window.getComputedStyle(A).getPropertyValue(e).replace(/\D/gi, "")))
                    })),
                    (window.getComputedStyle(A).getPropertyValue("border-top-width") || window.getComputedStyle(A).getPropertyValue("border-right-width") || window.getComputedStyle(A).getPropertyValue("border-bottom-width") || window.getComputedStyle(A).getPropertyValue("border-left-width")) && (o.border = [null, null, null, null], ["top", "right", "bottom", "left"].forEach(function(e, t) {
                        var a = Math.round(Number(window.getComputedStyle(A).getPropertyValue("border-" + e + "-width").replace("px", ""))),
                        e = window.getComputedStyle(A).getPropertyValue("border-" + e + "-color").replace(/\s+/gi, "").replace("rgba(", "").replace("rgb(", "").replace(")", "").split(","),
                ...
                case "tfoot":
                    ...
                    break;
                default:
                    console.log("table parsing: unexpected table part: ".concat(t))
                }
            })
        }),
        r._arrObjTabHeadRows = l || null,
        r.colW = s,
        ye(Q(Q(Q([], l, !0), c, !0), i, !0), r, A.presLayout, a).forEach(function(e, t) {
            var a = A.addSlide({
                masterName: r.masterSlideName || null
            });
            0 === t && (r.y = r.y || d[0]),
            0 < t && (r.y = r.autoPageSlideStartY || r.newSlideStartY || d[0]),
            r.verbose && console.log("| opts.autoPageSlideStartY: ".concat(r.autoPageSlideStartY, " / arrInchMargins[0]: ").concat(d[0], " => opts.y = ").concat(r.y)),
            a.addTable(e.rows, {
                x: r.x || d[3],
                y: r.y,
                w: Number(o) / F,
            ...
            r.addImage && (r.addImage.options = r.addImage.options || {},
            r.addImage.image && (r.addImage.image.path || r.addImage.image.data) ? a.addImage({
            ...
            r.addShape && a.addShape(r.addShape.shapeName, r.addShape.options || {}),
            r.addTable && a.addTable(r.addTable.rows, r.addTable.options || {}),
